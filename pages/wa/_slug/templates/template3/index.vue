<template>
  <div class="content-home" v-loading="loading">
    <KoHeaderWa :dataStore="dataStore"></KoHeaderWa>
    <KoCategoriesWa :dataStore="dataStore"></KoCategoriesWa>
    <KoProductListWa
      :dataStore="dataStore"
      :fullProducts="fullProducts"
    ></KoProductListWa>
    <KoFooterWa :dataStore="dataStore"></KoFooterWa>
  </div>
</template>
<script>
import KoHeaderWa from '../../../../../components/headers/header_wp/header_wp3/Ko-Header-wa-3'
import KoCategoriesWa from '../../../../../components/whatsapp/template3/ko-slide-categorys'
...
export default {
  name: 'indexWaTemp3',
  components: { KoHeaderWa, KoCategoriesWa, KoProductListWa, KoFooterWa },
  computed: {
    loading() {
