export default {
  es: {
    ...
    header_productos_hoko: 'Productos Hoko',
  ...
  en: {
    ...
    header_productos_hoko: 'Products Hoko',
  ...
  fr: {
    ...
    header_productos_hoko: 'Produits Hoko',
    header_contacto: 'Contact',
    ...
    footer_checkbox:
      'J´accepte de recevoir des e-mails et des informations de la part de Sticker hipster, dans le cadre de la politique de données personnelles.',
    footer_email: 'E-mail',
    ...
    contact_subtitle:
      'Nous sommes toujours à l´écoute de nos clients, n´hésitez pas à nous faire part de vos opinions et de vos doutes.',
    ...
    newsletter_msg:
      'J´accepte de recevoir des e-mails et des informations, dans le cadre de la politique de données personnelles.',
    // General
    ...
    productdetail_opcionesPagoMsg:
      'Vous pouvez choisir l´un de ces moyens. C´est rapide, sûr et sans coût supplémentaire.',
    productdetail_PasarelaEpayco: 'Passerelle de paiement Epayco ',
    productdetail_PasarelaEpaycoMsg:
      'Payez avec votre carte jusqu´à 24 versements ou en espèces dans plus de 14 000 points dans tout le pays.',
    ...
    productdetail_PasarelaMercadoMsg:
      'Différez votre achat jusqu´à 36 versements par carte de crédit, plus de 90 millions de personnes l´utilisent en Amérique latine.',
    ...
    productdetail_opinionesEnvioMsg1:
      'La valeur de l´envoi est calculée au moment de l´achat en fonction de la ville de livraison.',
    productdetail_opinionesEnvioMsg2:
      'Le coût de l´envoi est le même quel que soit le lieu de livraison.',
    productdetail_precioTotalCompra: 'Prix d´achat total',
    productdetail_precioTotalCompraMsg:
      ' La valeur de l´envoi est calculée en fonction du total de l´achat.',
    ...
    productdetail_ConsignacionCredibancoMsg:
      'Payez avec votre carte jusqu´à 24 versements ou en espèces dans tout le pays.',
