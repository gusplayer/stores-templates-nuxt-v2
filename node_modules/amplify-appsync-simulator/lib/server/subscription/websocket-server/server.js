...
exports.WebsocketSubscriptionServer = void 0;
...
var DEFAULT_OPTIONS = {
    onConnectHandler: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/];
    }); }); },
...
var WebsocketSubscriptionServer = /** @class */ (function () {
    function WebsocketSubscriptionServer(options, server) {
        var _this = this;
        this.onClose = function (connectionContext) {
            connectionContext.subscriptions.forEach(function (subscriptionId) {
                _this.stopAsyncIterator(connectionContext, subscriptionId.id);
            });
            ...
            _this.connections.delete(connectionContext);
        };
        this.onUnsubscribe = function (connectionContext, messageOrSubscriptionId) {
            var id = messageOrSubscriptionId.id;
            _this.stopAsyncIterator(connectionContext, id);
            _this.sendMessage(connectionContext, id, message_types_1.MESSAGE_TYPES.GQL_COMPLETE, {});
        };
        this.stopAsyncIterator = function (connectionContext, id) {
            if (connectionContext.subscriptions && connectionContext.subscriptions.has(id)) {
                var subscription = connectionContext.subscriptions.get(id);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        headers = utils_1.decodeHeaderFromQueryParam(request.url);
                    ...
                    case 2:
                        ...
                        onMessage_1 = function (message) {
                            _this.onMessage(connectionContext_1, message);
                        };
                        onClose_1 = function (error) {
                            socket.off('message', onMessage_1);
                            socket.off('close', onClose_1);
                            socket.off('error', onClose_1);
                            _this.onSocketDisconnection(connectionContext_1, error);
                        };
        ...
        this.onSocketDisconnection = function (connectionContext, error) {
            _this.onClose(connectionContext);
            if (error) {
                _this.sendError(connectionContext, '', { message: error instanceof Error ? error.message : error });
                setTimeout(function () {
            ...
            try {
                switch (message.type) {
                    case message_types_1.MESSAGE_TYPES.GQL_CONNECTION_INIT:
                        if (message_type_guards_1.isSubscriptionConnectionInitMessage(message)) {
                            return _this.onConnectionInit(connectionContext, message);
                        }
                        break;
                    case message_types_1.MESSAGE_TYPES.GQL_START:
                        if (message_type_guards_1.isSubscriptionStartMessage(message)) {
                            return _this.onSubscriptionStart(connectionContext, message);
                        }
                        break;
                    case message_types_1.MESSAGE_TYPES.GQL_STOP:
                        if (message_type_guards_1.isSubscriptionStopMessage(message)) {
        ...
        this.onConnectionInit = function (connectionContext, message) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query = graphql_1.parse(data.query);
                        variables = data.variables;
                        headers = message.payload.extensions.authorization;
                        if (connectionContext.subscriptions && connectionContext.subscriptions.has(id)) {
                            this.stopAsyncIterator(connectionContext, id);
                        }
                        return [4 /*yield*/, this.options.onSubscribeHandler(query, variables, headers, connectionContext.request)];
                    case 1:
        ...
        this.attachAsyncIterator = function (connectionContext, sub) { return __awaiter(_this, void 0, void 0, function () {
            var asyncIterator, id, _a, value, done;
    ...
    WebsocketSubscriptionServer.prototype.attachWebServer = function (serverOptions) {
        this.webSocketServer = new ws_1.Server(serverOptions || {});
    };
