...
var AppSyncUnitResolver = /** @class */ (function (_super) {
    ...
    AppSyncUnitResolver.prototype.resolve = function (source, args, context, info) {
        return __awaiter(this, void 0, void 0, function () {
            var requestMappingTemplate, responseMappingTemplate, dataLoader, _a, requestPayload, requestTemplateErrors, isReturn, result, error, e_1, _b, responseTemplateResult, responseTemplateErrors;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = requestMappingTemplate.render({ source: source, arguments: args }, context, info), requestPayload = _a.result, requestTemplateErrors = _a.errors, isReturn = _a.isReturn;
