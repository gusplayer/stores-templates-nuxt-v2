...
exports.fetchPermissionCategories = (permissionMap) => {
    return lodash_1.default.keys(permissionMap);
};
exports.fetchPermissionResourcesForCategory = (permissionMap, category) => {
    return lodash_1.default.keys(lodash_1.default.get(permissionMap, [category]));
};
exports.fetchPermissionsForResourceInCategory = (permissionMap, category, resourceName) => {
