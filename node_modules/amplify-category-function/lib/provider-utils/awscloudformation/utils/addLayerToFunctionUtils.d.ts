...
export declare const askLayerSelection: (layerMetadataFactory: LayerMetadataFactory, amplifyMeta: any, runtimeValue: string, previousSelections?: LambdaLayer[]) => Promise<{
