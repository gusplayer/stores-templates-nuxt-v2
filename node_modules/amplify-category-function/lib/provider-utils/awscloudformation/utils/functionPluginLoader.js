...
async function runtimeWalkthrough(context, params) {
    ...
    const selectionOptions = {
        ...
        selectionPrompt: service === "LambdaLayer" ? 'Select up to 2 compatible runtimes:' : 'Choose the runtime that you want to use:',
...
async function getSelectionsFromContributors(context, selectionOptions) {
    ...
    if (selections.length === 0) {
        ...
        let answer = await inquirer_1.default.prompt([
            {
                type: selectionOptions.service === "LambdaLayer" ? 'checkbox' : 'list',
                name: 'selection',
