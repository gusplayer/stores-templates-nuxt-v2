<template>
  <div class="wrapper-contact" :style="Settings">
    <div class="contact">
      ...
      <div class="contact-content">
        ...
        <div v-if="dataStore.geolocalizacion.length">
          <div>
            ...
            <p class="contact-text-subtitle2">{{ this.dataStore.geolocalizacion[0].direccion }}</p>
          </div>
          <iframe
            :src="
      ...
      <div class="contact-content">
        <div class="contact-item-text">
          ...
          <p class="contact-text-subtitles">Envíanos un mensaje y pronto estaremos en contacto.</p>
        </div>
        <form class="contact-content-rigth">
          ...
          />
          <P>E-MAIL</P>
          <input class="input-text" type="email" v-model="email" placeholder="Tu correo" required />
          <P>MENSAJE</P>
          <textarea
          ...
          <div class="input-content">
            <input
              ...
              required
            />
            <button ref="colorBtn" class="btn" v-on:click="submitContact">Enviar</button>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  colorCSS(value) {
    ...
    if (colorInt > 75) {
      colorArray[2] = `${parseInt(colorArray[2]) - 10}%`;
      this.$refs.colorBtn.style.setProperty("--btnhover", colorArray.join(","));
    } else {
      colorArray[2] = `${parseInt(colorArray[2]) + 10}%`;
      this.$refs.colorBtn.style.setProperty("--btnhover", colorArray.join(","));
    }
