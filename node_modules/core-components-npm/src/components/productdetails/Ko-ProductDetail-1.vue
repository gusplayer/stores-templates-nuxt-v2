<template>
  <div class="wrapper-productDetail" :style="Settings">
...
export default {
  ...
  methods: {
    async setBackgroungHover() {
      let color = await getComputedStyle(this.$refs.colorBtn).getPropertyValue(
      ...
      if (idOfSlug) {
        axios
          ...
          .then((response) => {
            ...
            this.loading = false
            this.$nextTick(() => this.setBackgroungHover())
          })
      } else {
