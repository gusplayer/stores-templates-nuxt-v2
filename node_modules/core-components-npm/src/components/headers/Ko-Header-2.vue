<template>
  <div class="wrapper-header" :style="currentSettingsHeader">
    <div class="header">
      <KoOrder :currentSettingsHeader="currentSettingsHeader" />
...
<script>
import KoOrder from "../_order/order1";
