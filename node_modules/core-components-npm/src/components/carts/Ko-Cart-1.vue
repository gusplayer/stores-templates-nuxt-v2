<template>
  <div class="wrapper-cart" ref="color" :style="Settings">
...
export default {
  ...
  computed: {
    ...
    colorCSS2() {
      return this.Settings["--color_background_btn_2"];
    }
  },
  methods: {
    ...
    setBackgroungHover() {
      ...
      if (colorInt > 75) {
        ...
        this.$refs.color.style.setProperty("--btnhover", colorArray.join(","));
      } else {
        colorArray[2] = `${parseInt(colorArray[2]) + 10}%`;
        this.$refs.color.style.setProperty("--btnhover", colorArray.join(","));
      }
    ...
    setBackgroungHover2() {
      let color = getComputedStyle(this.$refs.colorBtn2).getPropertyValue(
        "--color_background_btn_2"
      );
      let colorArray = color.split(",");
      let colorInt = parseInt(colorArray[2]);
      if (colorInt > 75) {
        colorArray[2] = `${parseInt(colorArray[2]) - 20}%`;
        this.$refs.color.style.setProperty("--btnhover2", colorArray.join(","));
      } else {
        colorArray[2] = `${parseInt(colorArray[2]) + 20}%`;
        this.$refs.color.style.setProperty("--btnhover2", colorArray.join(","));
      }
