...
module.exports = async function (req, res, next) {
  ...
  if (host.includes('buonavita.com.co')) {
    urls = [
      ...
      { url: '/productos?page=1&category=Zapatos&subcategory=19656', priority: 0.8 },
      { url: '/productos?page=1&category=Sandalias&subcategory=18814', priority: 0.8 },
  ...
  try {
    ...
    const xml = await streamToPromise(Readable.from(urls).pipe(stream)).then(d => d.toString())
