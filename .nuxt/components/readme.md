...
- `<BlogKoArticulo>` | `<blog-ko-articulo>` (components/blog/Ko-articulo.vue)
- `<BlogKoBlog>` | `<blog-ko-blog>` (components/blog/Ko-Blog.vue)
...
- `<Template12ProductDetail>` | `<template12-product-detail>` (components/template12/productDetail.vue)
...
- `<BlogBlogcardKoCardblog>` | `<blog-blogcard-ko-cardblog>` (components/blog/_blogcard/Ko-cardblog.vue)
...
- `<FootersFooter1Ko6Footer1>` | `<footers-footer1-ko6-footer1>` (components/footers/footer1/Ko6-Footer-1.vue)
...
- `<Template11ProductdetailsOptTabHoko>` | `<template11-productdetails-opt-tab-hoko>` (components/template11/_productdetails/OptTab-hoko.vue)
