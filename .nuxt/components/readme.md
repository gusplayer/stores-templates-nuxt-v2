...
- `<Template14CardBlogKoBlog>` | `<template14-card-blog-ko-blog>` (components/template14/_cardBlog/KoBlog.vue)
- `<Template14CardBlogKoBlogCard>` | `<template14-card-blog-ko-blog-card>` (components/template14/_cardBlog/Ko_BlogCard.vue)
