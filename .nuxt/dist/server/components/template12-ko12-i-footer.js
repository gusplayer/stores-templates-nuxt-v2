...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template12/Ko12-IFooter.vue?vue&type=template&id=56f267ec&scoped=true&
var render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"header-content-logo\" data-v-56f267ec>", "</div>", [_c('nuxt-link', {
  ...
  })])], 1), _vm._ssrNode(" <p class=\"text-title\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.footerText};`, null) + " data-v-56f267ec>" + _vm._ssrEscape("\n    " + _vm._s(_vm.settingByTemplate12.footerTitle) + "\n  ") + "</p> "), _vm._ssrNode("<div class=\"content-items-iconos\" data-v-56f267ec>", "</div>", _vm._l(_vm.links, function (item, index) {
    return _vm._ssrNode("<div" + _vm._ssrStyle(null, null, {
      display: item.link ? '' : 'none'
    }) + " data-v-56f267ec>", "</div>", [item.link ? _vm._ssrNode("<a" + _vm._ssrAttr("href", item.link) + " target=\"_blank \"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.footerText}; fill:${_vm.settingByTemplate12.footerText};`, null) + " data-v-56f267ec>", "</a>", [_c(item.icon, {
      tag: "div",
      staticClass: "icon"
    })], 1) : _vm._e()]);
  }), 0), _vm._ssrNode(" " + (_vm.dataStore.politicas ? "<button class=\"text-politics\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.footerText} ;`, null) + " data-v-56f267ec><p data-v-56f267ec>" + _vm._ssrEscape(_vm._s(_vm.$t('footer_politicasyterminos'))) + "</p></button>" : "<!---->") + " "), _vm.showModal ? _vm._ssrNode("<div data-v-56f267ec>", "</div>", [_vm.dataStore.politicas ? _vm._ssrNode("<div class=\"modal\" data-v-56f267ec>", "</div>", [_c('KoTermsConditions', {
    attrs: {
      "dataStore": _vm.dataStore
    }
  })], 1) : _vm._e()]) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"footer_resources w-full text-gray-400 text-center text-sm font-normal\" data-v-56f267ec>", "</div>", [_vm._ssrNode("<hr class=\"border-t border-gray-200 w-full\" data-v-56f267ec> "), _vm._ssrNode("<div class=\"madebyKomercia\" data-v-56f267ec>", "</div>", [_vm._ssrNode("<p class=\"txt-devBy\" data-v-56f267ec>" + _vm._ssrEscape(_vm._s(_vm.$t('footer_desarrollado'))) + "</p> "), _vm._ssrNode("<a href=\"https://komercia.co/\" target=\"_blank\" rel=\"noreferrer noopener\" data-v-56f267ec>", "</a>", [_vm.logo == true ? _c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
...
// CONCATENATED MODULE: ./components/template12/Ko12-IFooter.vue?vue&type=template&id=56f267ec&scoped=true&
...
module.exports.__inject__ = function (context) {
  add("56ee803e", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IFooter_vue_vue_type_style_index_0_id_56f267ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(471);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IFooter_vue_vue_type_style_index_0_id_56f267ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IFooter_vue_vue_type_style_index_0_id_56f267ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IFooter_vue_vue_type_style_index_0_id_56f267ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IFooter_vue_vue_type_style_index_0_id_56f267ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".wrapper_footer[data-v-56f267ec]{align-items:center;display:flex;flex-direction:column;padding:40px 0 10px;position:relative;width:100%}.header-content-logo[data-v-56f267ec]{align-items:center;display:flex;justify-content:center;padding:2px 0}.wrapper-logo[data-v-56f267ec]{width:100%}.header-logo[data-v-56f267ec]{-o-object-fit:contain;object-fit:contain;-o-object-position:left;object-position:left}.text-title[data-v-56f267ec]{max-width:380px;padding:15px 0 20px}.text-politics[data-v-56f267ec],.text-title[data-v-56f267ec]{font-weight:400;text-align:center}.modal[data-v-56f267ec]{background-color:rgba(0,0,0,.4);height:100%;left:0;overflow:auto;padding-top:200px;position:fixed;top:0;width:100%;z-index:10}.content-items-iconos[data-v-56f267ec]{align-items:center;display:flex;flex-direction:row;justify-content:center;padding:15px 0 40px;width:100%}.icon[data-v-56f267ec]{font-size:28px;margin-right:10px}.icon[data-v-56f267ec]:hover{fill:grey;color:grey}.madebyKomercia[data-v-56f267ec]{align-items:center;display:flex;flex-direction:column;justify-content:center;margin-bottom:10px;margin-top:20px;width:100%}.txt-devBy[data-v-56f267ec]{color:var(--color_text);font-size:14px}.logo2[data-v-56f267ec]{opacity:.5;width:100px}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
