...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template12/Ko12-IMainSection.vue?vue&type=template&id=0f581dd0&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('main', [_vm._ssrNode("<div class=\"pt-20\"" + _vm._ssrStyle(null, `background:${_vm.settingByTemplate12.backgroundColor};`, null) + " data-v-0f581dd0>", "</div>", [_vm.dataStore.categorias.length > 0 ? _vm._ssrNode("<div data-v-0f581dd0>", "</div>", _vm._l(_vm.dataStore.categorias, function (category) {
    return _vm._ssrNode("<div class=\"pt-4 pb-4\" data-v-0f581dd0>", "</div>", [_vm._ssrNode("<header class=\"text-center\" data-v-0f581dd0><h2 class=\"text-title\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.titleColor};`, null) + " data-v-0f581dd0>" + _vm._ssrEscape("\n            " + _vm._s(category.nombre_categoria_producto) + "\n          ") + "</h2></header> "), _vm.dataStore.subcategorias.length > 0 ? _vm._ssrNode("<div data-v-0f581dd0>", "</div>", _vm._l(_vm.dataStore.subcategorias, function (subcategory, key) {
      return _vm._ssrNode("<div class=\"products-wrapper\"" + _vm._ssrStyle(null, null, {
        display: subcategory.categoria == category.id ? '' : 'none'
      }) + " data-v-0f581dd0>", "</div>", [_vm._ssrNode("<div class=\"subcategori-Content\" data-v-0f581dd0>" + (subcategory.categoria == category.id ? "<p class=\"text-subtitle\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.titleColor};`, null) + " data-v-0f581dd0>" + _vm._ssrEscape("\n                " + _vm._s(subcategory.nombre_subcategoria) + "\n              ") + "</p>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"products-content\" data-v-0f581dd0>", "</div>", _vm._l(_vm.fullProducts, function (product) {
        ...
        }) + " data-v-0f581dd0>", "</div>", [_c('ProductCard', {
          attrs: {
    ...
    }), 0) : _vm._ssrNode("<div class=\"products-content\" data-v-0f581dd0>", "</div>", _vm._l(_vm.fullProducts, function (product) {
      return _vm._ssrNode("<div" + _vm._ssrStyle(null, null, {
  ...
  }), 0) : _vm._ssrNode("<div data-v-0f581dd0>", "</div>", [_vm._ssrNode("<header class=\"text-center\" data-v-0f581dd0><h2 class=\"text-title\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate12.titleColor};`, null) + " data-v-0f581dd0>" + _vm._ssrEscape("\n          " + _vm._s(_vm.$t('header_productos')) + "\n        ") + "</h2></header> "), _vm._ssrNode("<div class=\"products-content\" data-v-0f581dd0>", "</div>", _vm._l(_vm.fullProducts, function (product) {
    return _vm._ssrNode("<div data-v-0f581dd0>", "</div>", [_c('ProductCard', {
      attrs: {
        "product": product,
        "dataStore": _vm.dataStore,
        "settingByTemplate12": _vm.settingByTemplate12
  ...
  }), 0)], 2), _vm._ssrNode(" "), _vm.showModal ? _vm._ssrNode("<div class=\"modal\" data-v-0f581dd0>", "</div>", [_c('ProductDetail', {
    attrs: {
      "dataStore": _vm.dataStore,
      "tempData": _vm.tempData,
      "settingByTemplate12": _vm.settingByTemplate12
    }
  })], 1) : _vm._e(), _vm._ssrNode(" <hr class=\"h-20 bg-transparent border-transparent\" data-v-0f581dd0> <hr class=\"border-transparent divider border-0\" data-v-0f581dd0>")], 2)]);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/template12/Ko12-IMainSection.vue?vue&type=template&id=0f581dd0&scoped=true&

// EXTERNAL MODULE: ./components/template12/ProductCard.vue + 4 modules
var ProductCard = __webpack_require__(115);

// EXTERNAL MODULE: ./components/template12/mixins/ComponentProps.vue + 2 modules
var ComponentProps = __webpack_require__(93);

// EXTERNAL MODULE: ./components/template12/productDetail.vue + 4 modules
var productDetail = __webpack_require__(253);
...
installComponents(component, {ProductCard: __webpack_require__(115).default,ProductDetail: __webpack_require__(253).default})
...
module.exports.__inject__ = function (context) {
  add("97465c32", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_productDetail_vue_vue_type_style_index_0_id_599006e4_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(163);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_productDetail_vue_vue_type_style_index_0_id_599006e4_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_productDetail_vue_vue_type_style_index_0_id_599006e4_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_productDetail_vue_vue_type_style_index_0_id_599006e4_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_productDetail_vue_vue_type_style_index_0_id_599006e4_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template12/productDetail.vue?vue&type=template&id=599006e4&scoped=true&
var render = function render() {
...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template12/productDetail.vue?vue&type=script&lang=js&
...
/* harmony default export */ var productDetailvue_type_script_lang_js_ = ({
  ...
  components: {
    selectGroup: () => __webpack_require__.e(/* import() */ 270).then(__webpack_require__.bind(null, 515)),
    ProductSlide: () => __webpack_require__.e(/* import() */ 13).then(__webpack_require__.bind(null, 1083))
  },
  mounted() {
...
/* harmony default export */ var productDetail = __webpack_exports__["default"] = (component.exports);
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("dd950696", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IMainSection_vue_vue_type_style_index_0_id_0f581dd0_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(367);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IMainSection_vue_vue_type_style_index_0_id_0f581dd0_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IMainSection_vue_vue_type_style_index_0_id_0f581dd0_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IMainSection_vue_vue_type_style_index_0_id_0f581dd0_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko12_IMainSection_vue_vue_type_style_index_0_id_0f581dd0_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".divider[data-v-0f581dd0]{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:50%;background-size:contain;height:3px;margin:0 auto;width:25%}.products-wrapper[data-v-0f581dd0]{align-items:center;justify-content:center;width:100%}.subcategori-Content[data-v-0f581dd0]{padding:30px 10px 20px}.products-content[data-v-0f581dd0],.subcategori-Content[data-v-0f581dd0]{margin:0 auto;max-width:940px;width:100%}.products-content[data-v-0f581dd0]{grid-column-gap:20px;-moz-column-gap:20px;column-gap:20px;display:grid;grid-template-columns:repeat(2,minmax(420px,1fr));padding:10px 10px 20px}.modal[data-v-0f581dd0]{background-color:#000;background-color:rgba(0,0,0,.4);height:100%;left:0;overflow:auto;padding-top:200px;position:fixed;top:0;width:100%;z-index:10}.text-title[data-v-0f581dd0]{font-size:2.25rem}.text-subtitle[data-v-0f581dd0],.text-title[data-v-0f581dd0]{font-weight:600;text-transform:uppercase}.text-subtitle[data-v-0f581dd0]{font-size:22px}@media (max-width:800px){.products-wrapper[data-v-0f581dd0]{grid-template-columns:repeat(1,minmax(100%,1fr))}.text-title[data-v-0f581dd0]{font-size:1.5rem}}@media (max-width:500px){.modal[data-v-0f581dd0]{padding-top:80px}.products-wrapper[data-v-0f581dd0]{padding:25px 10px 20px}.text-title[data-v-0f581dd0]{font-size:1.5rem}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
//# sourceMappingURL=ko12-i-main-section.js.map