...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template16/Ko16-ProductDetail.vue?vue&type=template&id=28979b38&scoped=true&
var render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode((_vm.loading ? "<div data-v-28979b38></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"w-full box-content flex items-center justify-center\" style=\"background-color: var(--background_color_2)\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full max-w-7xl flex flex-row items-center justify-start py-10 px-10 md:px-5\"" + _vm._ssrStyle(null, `color: ${_vm.settingByTemplate16[0].detailsProducts.color_breadCrumbs};`, null) + " data-v-28979b38>", "</div>", [_c('nuxt-link', {
    staticClass: "text-14",
    attrs: {
      "to": "/"
    }
  }, [_vm._v("\n        " + _vm._s(_vm.$t('header_inicio')) + "\n      ")]), _vm._ssrNode(" <p class=\"px-10 text-14 font-bold\" data-v-28979b38>&gt;</p> "), _c('nuxt-link', {
    staticClass: "text-14 font-bold",
    attrs: {
      "to": "/productos"
    }
  }, [_vm._v("\n        " + _vm._s(_vm.$t('header_productos')) + "\n      ")]), _vm._ssrNode(" <p class=\"px-10 text-14 font-bold\" data-v-28979b38>&gt;</p> " + (!_vm.loading ? "<p class=\"text-14 font-bold\" data-v-28979b38>" + _vm._ssrEscape("\n        " + _vm._s((_vm$data = _vm.data) === null || _vm$data === void 0 ? void 0 : (_vm$data$detalle = _vm$data.detalle) === null || _vm$data$detalle === void 0 ? void 0 : _vm$data$detalle.nombre) + "\n      ") + "</p>" : "<!---->"))], 2)]), _vm._ssrNode(" "), !_vm.loading ? _vm._ssrNode("<div class=\"w-full h-full flex justify-center items-center px-10 md:px-5 mt-40 max-w-7xl\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full h-full flex flex-col justify-center items-center\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full grid grid-cols-1 md:grid-cols-2 gap-4 justify-center items-start\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full flex flex-col justify-center items-center\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full flex flex-row items-start pb-10\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"hidden md:flex w-full h-full relative overflow-hidden mr-30 max-w-[110px] max-h-[442px] min-h-[442px]\" data-v-28979b38>", "</div>", [_c('div', {
    directives: [{
      name: "swiper",
    ...
    ref: "mySwiper"
  }, [_vm._ssrNode("<div class=\"swiper-wrapper w-full h-full\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"swiper-slide w-full h-full\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full h-full flex flex-col justify-stretch max-h-[100px] max-w-[100px]\" data-v-28979b38>", "</div>", [_c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
    ...
    return _vm._ssrNode("<div class=\"swiper-slide w-full h-full\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full h-full flex flex-col justify-stretch max-h-[100px] max-w-[100px]\" data-v-28979b38>", "</div>", [_c('img', {
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"swiper-slide w-full h-full\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div class=\"w-full h-full flex flex-col justify-stretch max-h-[100px] max-w-[100px]\" data-v-28979b38>", "</div>", [_vm.idYoutube ? _c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
  ...
  }, []) : _vm._e()])])], 2), _vm._ssrNode(" "), _vm.data.fotos.length > 3 ? _vm._ssrNode("<div class=\"swiper-prev\" data-v-28979b38>", "</div>", [_c('FlechaUp-icon', {
    staticClass: "icon-swiper"
  })], 1) : _vm._e(), _vm._ssrNode(" "), _vm.data.fotos.length > 3 ? _vm._ssrNode("<div class=\"swiper-next\" data-v-28979b38>", "</div>", [_c('Flechadown-icon', {
    staticClass: "icon-swiper"
  })], 1) : _vm._e()], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"relative hidden md:flex w-full h-full max-w-[375px] max-h-[375px] mr-10\" data-v-28979b38>", "</div>", [_vm.activeZoom && !_vm.existYoutube ? _vm._ssrNode("<div class=\"w-full h-full max-w-[375px] max-h-[375px] object-contain rounded-10 object-top\" data-v-28979b38>", "</div>", [_c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
  ...
  }) + " data-v-28979b38></iframe>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"w-full h-full box-border flex md:hidden justify-start items-center\" data-v-28979b38>", "</div>", [_c('ProductSlide', {
  ...
  })], 1)], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"w-full flex flex-col justify-start items-start\" data-v-28979b38>", "</div>", [_vm._ssrNode("<p class=\"mb-20\"" + _vm._ssrStyle(null, `font-size:${_vm.settingByTemplate16[0].detailsProducts.color_title} !important; font-weight:${_vm.settingByTemplate16[0].detailsProducts.fontWeightTitle}; color:${_vm.settingByTemplate16[0].detailsProducts.color_title};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n            " + _vm._s(_vm.data.detalle.nombre) + "\n          ") + "</p> <div class=\"w-full flex flex-row justify-start items-center mb-20\" data-v-28979b38>" + (_vm.salesData.precio ? "<p" + _vm._ssrStyle(null, `font-size:${_vm.settingByTemplate16[0].detailsProducts.fontSizePrice}; font-weight:${_vm.settingByTemplate16[0].detailsProducts.fontWeightPrice}; color:${_vm.settingByTemplate16[0].detailsProducts.color_price};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm._f("currency")(_vm.salesData.precio, _vm.dataStore.tienda.codigo_pais, _vm.dataStore.tienda.moneda)) + "\n            ") + "</p>" : "<!---->") + " " + (_vm.data.info.tag_promocion == 1 && _vm.data.info.promocion_valor && _vm.salesData.precio ? "<div class=\"w-full flex flex-row justify-start items-center\" data-v-28979b38><p class=\"text-12 mx-5 bg-red-500 text-white-white px-3 py-5 rounded-4\" data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.data.info.promocion_valor) + "% De Descuento\n              ") + "</p> <p class=\"line-through\"" + _vm._ssrStyle(null, `font-size:${_vm.settingByTemplate16[0].detailsProducts.fontSizePriceDescount}; font-weight:${_vm.settingByTemplate16[0].detailsProducts.fontWeightPriceDescount}; color:${_vm.settingByTemplate16[0].detailsProducts.color_priceDescount};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm._f("currency")(_vm.data.info.tag_promocion == 1 && _vm.data.info.promocion_valor ? Math.trunc(_vm.salesData.precio / (1 - _vm.data.info.promocion_valor / 100)) : 0, _vm.dataStore.tienda.codigo_pais, _vm.dataStore.tienda.moneda)) + "\n              ") + "</p></div>" : "<!---->") + "</div> " + (_vm.data.info.descripcion_corta ? "<div class=\"w-full mb-25 pt-10\" data-v-28979b38><p class=\"text-14\"" + _vm._ssrStyle(null, ` color:${_vm.settingByTemplate16[0].detailsProducts.color_subtext};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.data.info.descripcion_corta) + "\n            ") + "</p></div>" : "<!---->") + " "), _vm.data.detalle.con_variante > 0 ? _vm._ssrNode("<div class=\"w-full mb-15\" data-v-28979b38>", "</div>", _vm._l(_vm.data.variantes, function (variant, index) {
    return _vm._ssrNode("<div class=\"flex flex-col justify-center items-start\" data-v-28979b38>", "</div>", [_vm._ssrNode("<label for=\"variant name\" class=\"text-16 font-bold\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(variant.nombre) + ":\n              ") + "</label> "), _c('SelectGroup', {
      attrs: {
        "index": index,
  ...
  }), 0) : _vm._e(), _vm._ssrNode(" " + (_vm.userDropshipping.userName ? "<div class=\"w-full flex flex-row items-center mb-30\" data-v-28979b38><p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('productdetail_dropshipping')) + "\n            ") + "</p> <p class=\"text-14\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_subtext};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.userDropshipping.userName) + "\n            ") + "</p></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"w-full flex flex-row justify-start items-center mb-20\" data-v-28979b38>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("flex flex-row justify-center items-center mr-20 border-2", {
    disabled: !_vm.salesData.estado
  }) + _vm._ssrStyle(null, `border-color:${_vm.settingByTemplate16[0].detailsProducts.color_border}; border-radius: ${_vm.settingByTemplate16[0].settingsGeneral.radius};`, null) + " data-v-28979b38>", "</div>", [_vm._ssrNode("<button class=\"bg-transparent text-center text-14 px-15\" data-v-28979b38>", "</button>", [_c('menos-icon', {
    staticClass: "icon",
    style: `color:${_vm.settingByTemplate16[0].detailsProducts.color_icon};`
  })], 1), _vm._ssrNode(" <input name=\"quantityValue\" type=\"text\" onkeypress=\"return (event.charCode>47 && event.charCode<58)\"" + _vm._ssrAttr("value", _vm.quantityValue) + " class=\"bg-transparent text-center text-14 py-11 px-10 max-w-[68px] font-bold\" data-v-28979b38> "), _vm._ssrNode("<button class=\"bg-transparent text-center text-14 px-15\" data-v-28979b38>", "</button>", [_c('mas-icon', {
    staticClass: "icon",
    style: `color:${_vm.settingByTemplate16[0].detailsProducts.color_icon};`
  })], 1), _vm._ssrNode(" " + (_vm.maxQuantityValue == _vm.quantityValue ? "<div class=\"absolute py-3 px-5 bg-yellow-300 rounded-4 -bottom-35 w-full max-w-[300px] text-center\" data-v-28979b38><span class=\"text-14 text-black\" data-v-28979b38>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.$t('cart_ultimaUnidad')) + "\n                ") + "</span></div>" : "<!---->"))], 2), _vm._ssrNode(" " + (!_vm.spent && _vm.salesData.estado == true && (_vm.data.info.tipo_servicio == null || _vm.data.info.tipo_servicio == '0') ? "<button id=\"AddToCartTag\" class=\"w-full flex justify-center items-center max-w-[300px] py-11 px-10 rounded-5\"" + _vm._ssrStyle(null, `background-color: ${_vm.settingByTemplate16[0].detailsProducts.color_btn}; color: ${_vm.settingByTemplate16[0].detailsProducts.color_text_btn}; border-radius: ${_vm.settingByTemplate16[0].settingsGeneral.radius};`, null) + " data-v-28979b38><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\"" + _vm._ssrAttr("fill", _vm.settingByTemplate16[0].detailsProducts.color_icon) + " viewBox=\"0 0 16 16\" class=\"mx-5\" data-v-28979b38><path d=\"M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l1.25 5h8.22l1.25-5H3.14zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z\" data-v-28979b38></path></svg>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('productdetail_añadiralcarrito')) + "\n            ") + "</button>" : !_vm.salesData.estado ? "<button disabled=\"disabled\" class=\"w-full flex justify-center items-center max-w-[300px] py-11 px-10 rounded-5\"" + _vm._ssrStyle(null, `background-color: ${_vm.settingByTemplate16[0].detailsProducts.color_btn}; color: ${_vm.settingByTemplate16[0].detailsProducts.color_text_btn}; border-radius: ${_vm.settingByTemplate16[0].settingsGeneral.radius};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('productdetail_btnANodisponible')) + "\n            ") + "</button>" : !_vm.spent && _vm.data.info.tipo_servicio == '1' ? "<button id=\"AddToCartTag\" class=\"w-full flex justify-center items-center max-w-[300px] py-11 px-10 rounded-5\"" + _vm._ssrStyle(null, `background-color: ${_vm.settingByTemplate16[0].detailsProducts.color_btn}; color: ${_vm.settingByTemplate16[0].detailsProducts.color_text_btn}; border-radius: ${_vm.settingByTemplate16[0].settingsGeneral.radius};`, null) + " data-v-28979b38><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\"" + _vm._ssrAttr("fill", _vm.settingByTemplate16[0].detailsProducts.color_icon) + " viewBox=\"0 0 16 16\" data-v-28979b38><path d=\"M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l1.25 5h8.22l1.25-5H3.14zM5 13a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z\" data-v-28979b38></path></svg>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('productdetail_btnComprar')) + "\n            ") + "</button>" : _vm.spent ? "<button disabled=\"disabled\" class=\"w-full flex justify-center items-center max-w-[300px] py-11 px-10 rounded-5\"" + _vm._ssrStyle(null, `background-color: ${_vm.settingByTemplate16[0].detailsProducts.color_btn}; color: ${_vm.settingByTemplate16[0].detailsProducts.color_text_btn}; border-radius: ${_vm.settingByTemplate16[0].settingsGeneral.radius};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('home_cardAgotado')) + "\n            ") + "</button>" : "<!---->"))], 2), _vm._ssrNode(" <div class=\"w-full flex flex-col mb-10\" data-v-28979b38>" + (_vm.salesData.unidades > 0 ? "<div class=\"flex flex-row justify-start items-center mb-10\" data-v-28979b38><p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.$t('productdetail_stock')) + ":\n              ") + "</p> <p" + _vm._ssrClass("text-14", `${_vm.salesData.unidades > 0 ? 'text-green-500' : 'text-red-500'}`) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.salesData.unidades > 0 ? 'In stock' : 'Out of stock') + "\n              ") + "</p></div>" : "<!---->") + " " + ((_vm$data$detalle2 = _vm.data.detalle) !== null && _vm$data$detalle2 !== void 0 && (_vm$data$detalle2$cat = _vm$data$detalle2.categoria_producto) !== null && _vm$data$detalle2$cat !== void 0 && _vm$data$detalle2$cat.nombre_categoria_producto ? "<div class=\"flex flex-row justify-start items-center mb-10\" data-v-28979b38><p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.$t('productdetail_categoria')) + ":\n              ") + "</p> <p class=\"text-14\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_subtext};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.data.detalle.categoria_producto.nombre_categoria_producto) + "\n              ") + "</p></div>" : "<!---->") + " " + ((_vm$data$detalle3 = _vm.data.detalle) !== null && _vm$data$detalle3 !== void 0 && (_vm$data$detalle3$sub = _vm$data$detalle3.subcategoria_producto) !== null && _vm$data$detalle3$sub !== void 0 && _vm$data$detalle3$sub.nombre_subcategoria ? "<div class=\"flex flex-row justify-start items-center mb-10\" data-v-28979b38><p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.$t('home_subcategory')) + ":\n              ") + "</p> <p class=\"text-14\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_subtext};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.data.detalle.subcategoria_producto.nombre_subcategoria) + "\n              ") + "</p></div>" : "<!---->") + " " + ((_vm$data$detalle4 = _vm.data.detalle) !== null && _vm$data$detalle4 !== void 0 && (_vm$data$detalle4$sub = _vm$data$detalle4.subcategoria_producto) !== null && _vm$data$detalle4$sub !== void 0 && _vm$data$detalle4$sub.nombre_subcategoria ? "<div class=\"flex flex-row justify-start items-center mb-10\" data-v-28979b38><p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n                " + _vm._s(_vm.$t('home_cardGratis')) + "\n              ") + "</p></div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"w-full flex flex-row items-center mb-10\" data-v-28979b38>", "</div>", [_vm._ssrNode("<p class=\"text-16 font-bold mr-10\"" + _vm._ssrStyle(null, `color:${_vm.settingByTemplate16[0].detailsProducts.color_text};`, null) + " data-v-28979b38>" + _vm._ssrEscape("\n              " + _vm._s(_vm.$t('productdetail_compartir')) + "\n            ") + "</p> "), _vm._ssrNode("<a" + _vm._ssrAttr("href", _vm.sharingFacebook) + " target=\"_blank\" rel=\"noreferrer noopener\" class=\"btn-facebook\" data-v-28979b38>", "</a>", [_c('facebook-icon', {
    staticClass: "wp-icon"
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<button class=\"btn-whatsapp\" data-v-28979b38>", "</button>", [_c('whatsapp-icon', {
    staticClass: "wp-icon"
...
// CONCATENATED MODULE: ./components/template16/Ko16-ProductDetail.vue?vue&type=template&id=28979b38&scoped=true&
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-28979b38]{font-family:var(--font-style-1)!important}.btn-facebook[data-v-28979b38]{background-color:transparent;border-radius:5px;color:#1877f2;cursor:pointer;display:flex;justify-content:center;margin-right:20px;text-align:center;-webkit-text-decoration:none;text-decoration:none;transition:all .2s ease-in;width:10px}.btn-facebook[data-v-28979b38]:hover{color:#000}.btn-whatsapp[data-v-28979b38]{background-color:transparent;border-radius:5px;color:#25d366;cursor:pointer;display:flex;justify-content:center;text-align:center;-webkit-text-decoration:none;text-decoration:none;transition:all .2s ease-in;width:10px}.btn-whatsapp[data-v-28979b38]:hover{color:#000}.wp-icon[data-v-28979b38]{bottom:3px;font-size:27px}.swiper-prev[data-v-28979b38]{top:0}.swiper-next[data-v-28979b38],.swiper-prev[data-v-28979b38]{left:20px;position:absolute;z-index:2}.swiper-next[data-v-28979b38]{bottom:0;font-size:25px}.icon-swiper[data-v-28979b38]{color:var(--color_icon);cursor:pointer;font-size:60px}.icon-swiper[data-v-28979b38]:hover{color:var(--hover_text)}.video[data-v-28979b38]{border-radius:10px;height:100px;margin-bottom:10px;min-height:100px;-o-object-fit:cover;object-fit:cover;-o-object-position:center;object-position:center;width:100px}.icon[data-v-28979b38]:hover{color:var(--hover_text)}@media (min-width:300px){.video[data-v-28979b38]{height:200px;width:100%}}@media (min-width:480px){.video[data-v-28979b38]{height:250px}}@media (min-width:768px){.video[data-v-28979b38]{height:400px}}@media (min-width:850px){.video[data-v-28979b38]{height:480px}}@media (min-width:1024px){.video[data-v-28979b38]{height:300px}}", ""]);
// Exports
