...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template5/Ko5-ProductListHome.vue?vue&type=template&id=3175f4a6&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "wrapper-productlist"
  }, [_vm._ssrNode("<div class=\"container-productlist\" data-v-3175f4a6>", "</div>", [_vm._ssrNode("<div class=\"content-title\" data-v-3175f4a6></div> <br data-v-3175f4a6> <div class=\"content-items-categorias\" data-v-3175f4a6><div class=\"content-items-categorias-text\" data-v-3175f4a6><p class=\"text-categorias\" data-v-3175f4a6>" + _vm._ssrEscape("\n          " + _vm._s(_vm.$t('home_catalogo')) + "\n        ") + "</p> " + (this.nameCategoryHeader ? "<p class=\"text-categorias-select\" data-v-3175f4a6>" + _vm._ssrEscape("\n          > " + _vm._s(this.nameCategoryHeader) + "\n        ") + "</p>" : "<!---->") + " " + (this.nameSubCategoryHeader ? "<p class=\"text-categorias-select\" data-v-3175f4a6>" + _vm._ssrEscape("\n          > " + _vm._s(this.nameSubCategoryHeader) + "\n        ") + "</p>" : "<!---->") + "</div></div> "), _vm._ssrNode("<div class=\"content-item\" data-v-3175f4a6>", "</div>", [_vm._ssrNode("<div class=\"content-item-productos\" data-v-3175f4a6>", "</div>", [_vm._ssrNode("<div class=\"grid-products\" data-v-3175f4a6>", "</div>", _vm._l(_vm.filterProduct, function (product) {
    return _vm._ssrNode("<div class=\"content-products\" data-v-3175f4a6>", "</div>", [_c('KoProductCard1', {
      attrs: {
        "product": product
      }
    })], 1);
  }), 0), _vm._ssrNode(" " + (this.fullProducts.length == 0 ? "<div class=\"content-products-empty\" data-v-3175f4a6><p data-v-3175f4a6>" + _vm._ssrEscape(_vm._s(_vm.$t('home_msgCatalogo'))) + "</p></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"pagination-medium\" data-v-3175f4a6>", "</div>", [_vm.fullProducts.length > 16 ? _vm._ssrNode("<div class=\"product_pagination\" data-v-3175f4a6>", "</div>", [_c('el-pagination', {
  ...
  })], 1) : _vm._e()]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"pagination-small\" data-v-3175f4a6>", "</div>", [_vm.fullProducts.length > 16 ? _vm._ssrNode("<div class=\"product_pagination\" data-v-3175f4a6>", "</div>", [_c('el-pagination', {
    staticClass: "pagination",
    attrs: {
      "background": "",
      "small": "",
...
// CONCATENATED MODULE: ./components/template5/Ko5-ProductListHome.vue?vue&type=template&id=3175f4a6&scoped=true&
...
module.exports.__inject__ = function (context) {
  add("eab8b7a0", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductListHome_vue_vue_type_style_index_0_id_3175f4a6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(321);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductListHome_vue_vue_type_style_index_0_id_3175f4a6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductListHome_vue_vue_type_style_index_0_id_3175f4a6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductListHome_vue_vue_type_style_index_0_id_3175f4a6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductListHome_vue_vue_type_style_index_0_id_3175f4a6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".wrapper-productlist[data-v-3175f4a6]{align-items:center;background:var(--background_color_2);box-sizing:border-box}.container-productlist[data-v-3175f4a6],.wrapper-productlist[data-v-3175f4a6]{display:flex;justify-content:center;width:100%}.container-productlist[data-v-3175f4a6]{flex-direction:column;max-width:1300px;padding:0 20px}.content-title[data-v-3175f4a6]{align-items:center;display:flex;justify-content:center;width:100%}.title[data-v-3175f4a6]{color:var(--color_text);font-size:38px;font-stretch:normal;font-style:normal;font-weight:700;letter-spacing:-.4px;line-height:1.24;margin-bottom:10px;margin-top:10px}.content-item-top[data-v-3175f4a6]{width:100%}.content-item[data-v-3175f4a6],.content-item-top[data-v-3175f4a6]{display:flex;flex-direction:row;justify-content:space-between}.content-item[data-v-3175f4a6]{align-items:center;margin-bottom:40px}.content-item>div[data-v-3175f4a6]:first-child{flex:1}.content-item>div[data-v-3175f4a6]:nth-child(2){flex:2}.content-filtrar[data-v-3175f4a6]{display:flex;flex-direction:row}.dropbtn[data-v-3175f4a6]{align-self:flex-end;background:transparent;color:var(--color_subtext);cursor:pointer;font-size:16px;font-weight:700;line-height:1.4;margin-right:2px}.content-items-categorias[data-v-3175f4a6]{align-items:center;justify-content:space-between;margin-bottom:20px}.content-items-categorias[data-v-3175f4a6],.content-items-categorias-text[data-v-3175f4a6]{display:flex;flex-direction:row}.text-categorias[data-v-3175f4a6]{font-size:18px}.text-categorias[data-v-3175f4a6],.text-categorias-select[data-v-3175f4a6]{align-self:flex-start;background:transparent;color:var(--color_subtext);cursor:pointer;display:flex;font-weight:700;line-height:1.4;margin-right:2px}.text-categorias-select[data-v-3175f4a6]{font-size:16px;margin-left:5px;margin-top:2px;opacity:.6}.dropdown-content[data-v-3175f4a6]{background-color:#fff;border-radius:10px;box-shadow:0 8px 20px 1px rgba(0,0,0,.2);display:none;position:absolute;z-index:2}.dropdown:hover .dropdown-content[data-v-3175f4a6]{display:block}.content-item-catalogo[data-v-3175f4a6]{align-self:baseline;background-color:var(--background_color_2);border-radius:10px;display:flex;max-width:205px;padding-bottom:10px;padding-top:10px;width:100%}.a-container[data-v-3175f4a6]{align-items:center;color:var(--color_subtext);display:block;font-size:16px;font-weight:700;justify-content:center;position:relative;transition:all .2s ease;width:205px}.a-container[data-v-3175f4a6],.item-categoria[data-v-3175f4a6]{background-color:var(--background_color_2);cursor:pointer}.item-categoria[data-v-3175f4a6]{padding:0 10px 0 20px}.item-categoria-active[data-v-3175f4a6],.item-categoria[data-v-3175f4a6]:hover{background:var(--color_background_hover);color:var(--color_hover_text)}.content-item-subcategorie[data-v-3175f4a6]{background:var(--color_background_hover);padding-left:40px;padding-right:10px}.item-subcategorie[data-v-3175f4a6]{cursor:pointer;font-size:13px;-webkit-user-select:none;-moz-user-select:none;user-select:none}.item-subcategorie-active[data-v-3175f4a6],.item-subcategorie[data-v-3175f4a6]:hover{background:var(--color_background_hover);color:var(--color_hover_text)}.content-item-productos[data-v-3175f4a6]{align-items:center;display:flex;flex-direction:column;justify-content:center;width:100%}.grid-products[data-v-3175f4a6]{grid-column-gap:25px;grid-row-gap:30px;box-sizing:border-box;display:grid;grid-template-columns:repeat(4,minmax(250px,2fr));margin:0 auto;width:100%}.content-products-empty[data-v-3175f4a6]{align-items:center;display:flex;justify-content:center;min-height:200px;text-align:center;width:100%}.content-products-empty p[data-v-3175f4a6]{color:var(--color_subtext);font-size:18px;font-weight:700;opacity:.6}.top-right[data-v-3175f4a6]{display:none}.header-icon-menu[data-v-3175f4a6]{color:var(--color_subtext);cursor:pointer;font-size:30px}.header-icon-close[data-v-3175f4a6]{color:rgba(21,20,57,.808);font-size:30px;margin-left:22px}.top-input-search[data-v-3175f4a6]{align-content:start;display:grid;justify-content:flex-end;position:relative}.top-input-search input[data-v-3175f4a6]{background-color:transparent;border:2px solid #afafaf;border-radius:var(--radius_btn);box-sizing:border-box;color:var(--color_subtext);font-size:14px;padding:10px 35px 10px 15px;width:100%}.top-input-search input[data-v-3175f4a6]::-moz-placeholder{color:var(--color_subtext);opacity:.7}.top-input-search input[data-v-3175f4a6]::placeholder{color:var(--color_subtext);opacity:.7}.top-input-search input[data-v-3175f4a6]:active,.top-input-search input[data-v-3175f4a6]:focus{border:2px solid var(--color_border_btn);border-radius:var(--radius_btn);outline:0}.top-input-search i.icon-search[data-v-3175f4a6]{color:var(--color_subtext);font-weight:700;position:absolute;right:15px;top:9px;z-index:2}.top-input-search .response[data-v-3175f4a6]{background-color:transparent;border:2px solid #d8d8d8;border-radius:var(--radius_btn);box-sizing:border-box;color:var(--color_subtext);font-size:12px;height:28px;justify-self:start;line-height:26px;padding:0 10px;white-space:nowrap}.pagination-medium[data-v-3175f4a6]{background:transparent;display:inline;display:initial;margin-top:20px}.pagination-small[data-v-3175f4a6]{display:none}.pagination[data-v-3175f4a6]{background:transparent;color:var(--color_text);font-size:18px}.product_pagination[data-v-3175f4a6] .el-pagination.is-background .btn-next,.product_pagination[data-v-3175f4a6] .el-pagination.is-background .btn-prev,.product_pagination[data-v-3175f4a6] .el-pagination.is-background .el-pager li{background-color:transparent;color:var(--color_text)}.product_pagination[data-v-3175f4a6] .el-pagination.is-background .btn-next:hover,.product_pagination[data-v-3175f4a6] .el-pagination.is-background .btn-prev:hover,.product_pagination[data-v-3175f4a6] .el-pagination.is-background .el-pager li:not(.disabled):hover{color:var(--btnhover)}.product_pagination[data-v-3175f4a6] .el-pagination.is-background .el-pager li:not(.disabled).active{background-color:var(--color_icon);color:#fff}@media (max-width:1290px){.grid-products[data-v-3175f4a6]{grid-column-gap:15px;grid-row-gap:30px;grid-template-columns:repeat(4,minmax(240px,2fr))}}@media (max-width:1265px){.grid-products[data-v-3175f4a6]{grid-column-gap:10px;grid-row-gap:30px;grid-template-columns:repeat(4,minmax(240px,2fr))}}@media (max-width:1250px){.grid-products[data-v-3175f4a6]{grid-column-gap:25px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(250px,2fr))}}@media (max-width:1060px){.grid-products[data-v-3175f4a6]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(250px,2fr))}}@media (max-width:1050px){.grid-products[data-v-3175f4a6]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1020px){.grid-products[data-v-3175f4a6]{grid-column-gap:15px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1010px){.grid-products[data-v-3175f4a6]{grid-column-gap:10px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1000px){.grid-products[data-v-3175f4a6]{grid-column-gap:25px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:790px){.grid-products[data-v-3175f4a6]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:780px){.grid-products[data-v-3175f4a6]{grid-column-gap:16px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:775px){.grid-products[data-v-3175f4a6]{grid-column-gap:20px;grid-row-gap:20px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:770px){.container-productlist[data-v-3175f4a6]{padding:0}.content-item-productos[data-v-3175f4a6]{padding:15px}.title[data-v-3175f4a6]{font-size:25px;margin-top:20px}.grid-products[data-v-3175f4a6]{grid-template-columns:repeat(2,minmax(10px,2fr))}.dropbtn[data-v-3175f4a6]{margin-left:5px}.text-categorias[data-v-3175f4a6]{padding:0 10px}.content-title[data-v-3175f4a6]{padding:0 15px}}@media (max-width:700px){.content-items-categorias[data-v-3175f4a6]{margin-bottom:0;margin-left:5px}}@media (max-width:450px){.grid-products[data-v-3175f4a6]{grid-template-columns:repeat(2,minmax(160px,1fr))}.content-item-productos[data-v-3175f4a6]{padding:5px}.pagination-medium[data-v-3175f4a6]{display:none}.pagination-small[data-v-3175f4a6]{background:transparent;display:inline;display:initial;margin-top:20px}}", ""]);
// Exports
...
//# sourceMappingURL=ko5-product-list-home.js.map