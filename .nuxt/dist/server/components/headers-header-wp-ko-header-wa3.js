...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/headers/header_wp/Ko-Header-wa-3.vue?vue&type=template&id=132c54ec&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "content-header"
  }, [_vm._ssrNode("<div class=\"content-header-items\" data-v-132c54ec>", "</div>", [_vm._ssrNode("<div class=\"content-banner-items\"" + _vm._ssrStyle(null, `background-image: url(${_vm.idCloudinaryBanner(_vm.bannerUrl, 'bannerRes', 900)});`, null) + " data-v-132c54ec>", "</div>", [_vm._ssrNode("<div class=\"content-data-store\"" + _vm._ssrStyle(null, `background: ${_vm.settingByTemplate.color_icon};`, null) + " data-v-132c54ec>", "</div>", [_vm._ssrNode("<div class=\"content-logo-name\" data-v-132c54ec>", "</div>", [_c('nuxt-link', {
  ...
  })]), _vm._ssrNode(" <div class=\"data-item-name\" data-v-132c54ec><p class=\"name-store\" data-v-132c54ec>" + _vm._ssrEscape("\n              " + _vm._s(_vm.dataStore.tienda.nombre) + "\n            ") + "</p> " + (_vm.settingByTemplate && _vm.settingByTemplate.mensaje_principal ? "<p class=\"category-store\" data-v-132c54ec>" + _vm._ssrEscape("\n              " + _vm._s(_vm.settingByTemplate.mensaje_principal) + "\n            ") + "</p>" : "<!---->") + "</div>")], 2), _vm._ssrNode(" "), _vm.settingByTemplate && _vm.settingByTemplate.descripcion ? _vm._ssrNode("<div class=\"content-seeMore\" data-v-132c54ec>", "</div>", [_vm._ssrNode((!_vm.showInfoStore ? "<p class=\"txt-seeMore\" data-v-132c54ec>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_cardvermas')) + "\n          ") + "</p>" : "<p class=\"txt-seeMore\" data-v-132c54ec>\n            Ver menos\n          </p>") + " "), _vm._ssrNode("<div data-v-132c54ec>", "</div>", [!_vm.showInfoStore ? _c('Flechadown-icon', {
  ...
  })], 1)], 2) : _vm._e()], 2)])]), _vm._ssrNode(" " + (_vm.showInfoStore ? "<div class=\"content-infoStore\" data-v-132c54ec>" + (_vm.settingByTemplate && _vm.settingByTemplate.descripcion ? "<div data-v-132c54ec><p class=\"txt-direccion\" data-v-132c54ec>" + _vm._ssrEscape("\n        " + _vm._s(_vm.settingByTemplate.descripcion) + "\n      ") + "</p></div>" : "<!---->") + "</div>" : "<!---->") + " "), _c('KoOrderWa', {
    attrs: {
...
// CONCATENATED MODULE: ./components/headers/header_wp/Ko-Header-wa-3.vue?vue&type=template&id=132c54ec&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/headers/header_wp/Ko-Header-wa-3.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./components/headers/header_wp/Ko-Header-wa-3.vue?vue&type=script&lang=js&
 /* harmony default export */ var header_wp_Ko_Header_wa_3vue_type_script_lang_js_ = (Ko_Header_wa_3vue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/headers/header_wp/Ko-Header-wa-3.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  header_wp_Ko_Header_wa_3vue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var Ko_Header_wa_3 = __webpack_exports__["default"] = (component.exports);
...
module.exports.__inject__ = function (context) {
  add("0ffc9df5", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_Header_wa_3_vue_vue_type_style_index_0_id_132c54ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(488);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_Header_wa_3_vue_vue_type_style_index_0_id_132c54ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_Header_wa_3_vue_vue_type_style_index_0_id_132c54ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_Header_wa_3_vue_vue_type_style_index_0_id_132c54ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_Header_wa_3_vue_vue_type_style_index_0_id_132c54ec_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".content-header[data-v-132c54ec]{align-items:center;display:flex;flex-direction:column;justify-content:center;width:100%}.imagen-redondo[data-v-132c54ec]{border-radius:100px}.imagen-cuadrado[data-v-132c54ec]{border-radius:5px}@media (min-width:300px){.content-header-items[data-v-132c54ec]{align-items:center;display:flex;flex-direction:column;justify-content:center;width:100%}.content-banner-items[data-v-132c54ec]{background-position:50%;background-repeat:no-repeat;background-size:cover;height:auto;margin-bottom:8px;margin-top:8px;width:95%}.content-banner-items[data-v-132c54ec],.content-data-store[data-v-132c54ec]{align-items:center;border-radius:9px;display:flex;flex-direction:column;justify-content:center;overflow:hidden}.content-data-store[data-v-132c54ec]{height:100%;width:100%}.content-logo-name[data-v-132c54ec]{flex-direction:row;margin-top:20px;width:100%}.content-logo-name[data-v-132c54ec],.data-item-logo[data-v-132c54ec]{align-items:center;display:flex;justify-content:center}.data-item-logo[data-v-132c54ec]{--tw-shadow:0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -2px rgba(0,0,0,.1);--tw-shadow-colored:0 4px 6px -1px var(--tw-shadow-color),0 2px 4px -2px var(--tw-shadow-color);background:#fff;box-shadow:0 0 transparent,0 0 transparent,0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -2px rgba(0,0,0,.1);box-shadow:var(--tw-ring-offset-shadow,0 0 transparent),var(--tw-ring-shadow,0 0 transparent),var(--tw-shadow);flex-direction:column;height:75px;margin-left:20px;margin-right:20px;width:110px}.logo-img[data-v-132c54ec]{background:transparent;height:100%;-o-object-fit:contain;object-fit:contain;-o-object-position:center;object-position:center;width:100%}.data-item-name[data-v-132c54ec]{align-items:center;display:flex;flex-direction:column;justify-content:center;margin-bottom:10px;margin-top:10px;width:100%}.name-store[data-v-132c54ec]{align-items:flex-start;color:#fff;display:flex;flex-direction:column;font-size:15px;font-weight:600;justify-content:center;width:100%}.category-store[data-v-132c54ec],.name-store[data-v-132c54ec]{font-family:\"Poppins\",sans-serif!important}.category-store[data-v-132c54ec]{align-items:flex-start;color:#fff;font-size:12px;font-weight:500;width:100%}.category-store[data-v-132c54ec],.content-category-data[data-v-132c54ec]{display:flex;flex-direction:column;justify-content:center}.content-category-data[data-v-132c54ec]{align-items:center;width:95%}.content-seeMore[data-v-132c54ec]{align-items:center;cursor:pointer;display:flex;flex-direction:row;justify-content:center;margin-bottom:10px;width:auto}.txt-seeMore[data-v-132c54ec]{align-items:center;color:#fff;display:flex;flex-direction:column;font-family:\"Poppins\",sans-serif!important;font-size:13px;font-weight:500;justify-content:center;padding-left:5px;width:auto}.svg-arrow[data-v-132c54ec]{fill:#fff;bottom:1px;color:#fff}.content-infoStore[data-v-132c54ec]{align-items:flex-start;background-color:#eaeaea;border-radius:9px;display:flex;flex-direction:column;justify-content:center;margin-bottom:10px;padding:15px;width:95%}.txt-direccion[data-v-132c54ec]{align-items:center;color:#3d3d3d;display:flex;font-family:\"Poppins\",sans-serif!important;font-size:13px;font-weight:500;justify-content:center;width:auto}}@media (min-width:375px){.content-banner-items[data-v-132c54ec]{height:120px}}@media (min-width:425px){.content-banner-items[data-v-132c54ec]{height:135px}.data-item-logo[data-v-132c54ec]{height:90px;width:110px}.name-store[data-v-132c54ec]{font-size:20px}.category-store[data-v-132c54ec]{font-size:15px}}@media (min-width:768px){.content-banner-items[data-v-132c54ec]{height:300px;margin-bottom:18px;margin-top:18px}.content-logo-name[data-v-132c54ec]{margin-bottom:20px;margin-top:0}.data-item-logo[data-v-132c54ec]{height:120px;width:150px}.name-store[data-v-132c54ec]{font-size:40px}.category-store[data-v-132c54ec]{font-size:26px}.txt-seeMore[data-v-132c54ec]{font-size:18px}.txt-direccion[data-v-132c54ec]{font-size:17px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
//# sourceMappingURL=headers-header-wp-ko-header-wa3.js.map