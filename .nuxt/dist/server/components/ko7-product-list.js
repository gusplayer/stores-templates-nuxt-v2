...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template7/Ko7-ProductList.vue?vue&type=template&id=c1938d2a&scoped=true&
var render = function render() {
  ...
  }, [_vm._ssrNode((!_vm.settingKCarousel.visible ? "<div class=\"separador-blog\" data-v-c1938d2a></div>" : "<!---->") + " "), _vm._ssrNode("<div id=\"section\" class=\"producto-items-content\"" + _vm._ssrStyle(null, [{
  ...
  }], null) + " data-v-c1938d2a>", "</div>", [_vm._ssrNode("<div class=\"product-text\" data-v-c1938d2a><div class=\"product-tittle\" data-v-c1938d2a><span class=\"tittle\" data-v-c1938d2a>" + _vm._ssrEscape(_vm._s(_vm.settingKProductList.pre_title)) + "</span></div> <div class=\"product-subtittle\" data-v-c1938d2a><span class=\"subtittle\" data-v-c1938d2a>" + _vm._ssrEscape(_vm._s(_vm.settingKProductList.title)) + "</span></div> <div class=\"product-description\" data-v-c1938d2a><span class=\"description\" data-v-c1938d2a>" + _vm._ssrEscape("\n          " + _vm._s(_vm.settingKProductList.description) + "\n        ") + "</span></div></div> "), _vm._ssrNode("<div class=\"content-item\" data-v-c1938d2a>", "</div>", [_vm._ssrNode("<div class=\"content-item-productos\" data-v-c1938d2a>", "</div>", [_vm._ssrNode("<div class=\"product-conten-items\" data-v-c1938d2a>", "</div>", _vm._l(_vm.listProducts, function (product) {
    return _vm._ssrNode("<div class=\"h-full\" data-v-c1938d2a>", "</div>", [_c('KoProductCard', {
      attrs: {
        "product": product,
  ...
  }), 0), _vm._ssrNode(" "), this.listProducts.length == 0 ? _vm._ssrNode("<div class=\"content-products-empty\" data-v-c1938d2a>", "</div>", [_vm._ssrNode("<div class=\"header-content-logo\" data-v-c1938d2a>", "</div>", [_c('nuxt-link', {
  ...
  })])], 1), _vm._ssrNode(" <p class=\"txt-products-empty\" data-v-c1938d2a>" + _vm._ssrEscape(_vm._s(_vm.$t('home_msgCatalogo'))) + "</p>")], 2) : _vm._e()], 2)])], 2)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/template7/Ko7-ProductList.vue?vue&type=template&id=c1938d2a&scoped=true&

// EXTERNAL MODULE: ./components/template7/_productcard/ProductCard.vue + 4 modules
var ProductCard = __webpack_require__(84);

// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template7/Ko7-ProductList.vue?vue&type=script&lang=js&

/* harmony default export */ var Ko7_ProductListvue_type_script_lang_js_ = ({
  name: 'Ko7-ProductList',
  components: {
...
// CONCATENATED MODULE: ./components/template7/Ko7-ProductList.vue?vue&type=script&lang=js&
 /* harmony default export */ var template7_Ko7_ProductListvue_type_script_lang_js_ = (Ko7_ProductListvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/template7/Ko7-ProductList.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  template7_Ko7_ProductListvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var Ko7_ProductList = __webpack_exports__["default"] = (component.exports);
...
module.exports.__inject__ = function (context) {
  add("d30a7c94", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko7_ProductList_vue_vue_type_style_index_0_id_c1938d2a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(333);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko7_ProductList_vue_vue_type_style_index_0_id_c1938d2a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko7_ProductList_vue_vue_type_style_index_0_id_c1938d2a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko7_ProductList_vue_vue_type_style_index_0_id_c1938d2a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko7_ProductList_vue_vue_type_style_index_0_id_c1938d2a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".product-content[data-v-c1938d2a]{align-items:center;background:var(--background_color_1);display:flex;flex-direction:column;justify-content:center;padding-bottom:50px;padding-top:50px;width:100%}.separador-blog[data-v-c1938d2a]{padding-top:100px}.product-text[data-v-c1938d2a]{align-items:center;justify-content:center;width:100%}.product-conten-items[data-v-c1938d2a],.product-text[data-v-c1938d2a]{display:flex;flex-direction:column}.product-conten-items[data-v-c1938d2a]{align-items:flex-start;justify-content:flex-start;margin-top:30px}.description[data-v-c1938d2a],.product-description[data-v-c1938d2a],.product-subtittle[data-v-c1938d2a],.product-tittle[data-v-c1938d2a],.producto-items-content[data-v-c1938d2a],.subtittle[data-v-c1938d2a],.tittle[data-v-c1938d2a]{align-items:center;display:flex;flex-direction:column;justify-content:center;text-align:center}.tittle[data-v-c1938d2a]{color:var(--color_pre_title);font-family:var(--font-style-2)!important}.subtittle[data-v-c1938d2a]{color:var(--color_title);font-family:var(--font-style-1)!important}.description[data-v-c1938d2a]{color:var(--color_description);font-family:var(--font-style-3)!important}.product-conten-items[data-v-c1938d2a]{gap:1rem}.content-item[data-v-c1938d2a]{align-items:center;display:flex;flex-direction:row;justify-content:space-between;margin-bottom:40px}.content-item-productos[data-v-c1938d2a],.content-products-empty[data-v-c1938d2a]{align-items:center;display:flex;flex-direction:column;justify-content:center;width:100%}.content-products-empty[data-v-c1938d2a]{min-height:200px;text-align:center}.txt-products-empty[data-v-c1938d2a]{color:#3f3f3f;font-family:\"David Libre\"!important;font-size:20px;font-weight:600;margin-top:6px}@media (min-width:300px){.producto-items-content[data-v-c1938d2a]{width:95%}.product-conten-items[data-v-c1938d2a]{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.tittle[data-v-c1938d2a]{font-size:24px;line-height:34px}.subtittle[data-v-c1938d2a]{font-size:32px;line-height:42px}.description[data-v-c1938d2a]{font-size:14px;line-height:24px}}@media (min-width:768px){.product-conten-items[data-v-c1938d2a]{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.subtittle[data-v-c1938d2a]{font-size:36px;line-height:46px}}@media (min-width:1024px){.product-text[data-v-c1938d2a]{width:100%}.product-conten-items[data-v-c1938d2a]{display:grid;grid-template-columns:repeat(4,minmax(0,1fr))}}@media (min-width:1280px){.producto-items-content[data-v-c1938d2a]{width:93%}}@media (min-width:1192px){.producto-items-content[data-v-c1938d2a]{width:1192px}}@media (min-width:1920px){.tittle[data-v-c1938d2a]{font-size:24px;line-height:34px}.subtittle[data-v-c1938d2a]{font-size:36px;line-height:46px}.description[data-v-c1938d2a]{font-size:14px;line-height:24px}}", ""]);
// Exports
...
//# sourceMappingURL=ko7-product-list.js.map