...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template16/_offers/countdown.vue?vue&type=template&id=3d8a5ed4&
var render = function render() {
  var _vm$settingGeneral, _vm$settingGeneral2, _vm$settingGeneral3, _vm$settingGeneral4, _vm$settingGeneral5;
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode((!_vm.isFinished ? "<div class=\"mt-30 grid grid-flow-col gap-x-4\"><div class=\"py-8 px-3 text-center w-[60px]\"" + _vm._ssrStyle(null, `color: ${_vm.information.color_text_discount}; background-color: ${_vm.information.color_bg_discount}; border-color: ${_vm.information.color_bg}; border-radius: ${(_vm$settingGeneral = _vm.settingGeneral) === null || _vm$settingGeneral === void 0 ? void 0 : _vm$settingGeneral.radius};`, null) + "><p class=\"text-18 font-bold\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.days) + "\n      ") + "</p> <span class=\"text-14\">días</span></div> <div class=\"py-8 px-3 text-center w-[60px]\"" + _vm._ssrStyle(null, `color: ${_vm.information.color_text_discount}; background-color: ${_vm.information.color_bg_discount}; border-color: ${_vm.information.color_bg}; border-radius: ${(_vm$settingGeneral2 = _vm.settingGeneral) === null || _vm$settingGeneral2 === void 0 ? void 0 : _vm$settingGeneral2.radius};`, null) + "><p class=\"text-18 font-bold\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.hours) + "\n      ") + "</p> <span class=\"text-14\">horas</span></div> <div class=\"py-8 px-3 text-center w-[60px]\"" + _vm._ssrStyle(null, `color: ${_vm.information.color_text_discount}; background-color: ${_vm.information.color_bg_discount}; border-color: ${_vm.information.color_bg}; border-radius: ${(_vm$settingGeneral3 = _vm.settingGeneral) === null || _vm$settingGeneral3 === void 0 ? void 0 : _vm$settingGeneral3.radius};`, null) + "><p class=\"text-18 font-bold\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.minutes) + "\n      ") + "</p> <span class=\"text-14\">min</span></div> <div class=\"py-8 px-3 text-center w-[60px]\"" + _vm._ssrStyle(null, `color: ${_vm.information.color_text_discount}; background-color: ${_vm.information.color_bg_discount}; border-color: ${_vm.information.color_bg}; border-radius: ${(_vm$settingGeneral4 = _vm.settingGeneral) === null || _vm$settingGeneral4 === void 0 ? void 0 : _vm$settingGeneral4.radius};`, null) + "><p class=\"text-18 font-bold\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.seconds) + "\n      ") + "</p> <span class=\"text-14\">seg</span></div></div>" : "<div class=\"mt-30 text-14 md:text-16 xl:text-20 font-semibold\"" + _vm._ssrStyle(null, `color: ${_vm.information.color_text_discount};`, null) + "><p>Oferta finalizada</p></div>") + " "), _vm._ssrNode("<div class=\"mt-40\">", "</div>", [_c('KoProductCard', {
    staticStyle: {
      "max-width": "300px"
    },
...
// CONCATENATED MODULE: ./components/template16/_offers/countdown.vue?vue&type=template&id=3d8a5ed4&
