...
var render = function render() {
  ...
  return _c('div', {
  ...
  }], null) + " data-v-77cfe10c><div class=\"tittle-banner-shop\" data-v-77cfe10c><p class=\"btn-tittle-shop\" data-v-77cfe10c>" + _vm._ssrEscape("\n        " + _vm._s(_vm.settingByTemplate7[0].productListFilter.title) + "\n      ") + "</p></div></div> "), _vm._ssrNode("<div class=\"content-shop-items\" data-v-77cfe10c>", "</div>", [_vm.categorias && _vm.categorias.length > 0 ? _vm._ssrNode("<div class=\"content-left\" data-v-77cfe10c>", "</div>", [_vm._ssrNode("<div class=\"content-category-left\" data-v-77cfe10c><button class=\"item-tittle\" data-v-77cfe10c><p class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('header_buscar_producto')) + "\n          ") + "</p></button> <div class=\"itemLeft-range-slide\" data-v-77cfe10c><input type=\"search\"" + _vm._ssrAttr("placeholder", _vm.$t('header_search')) + _vm._ssrAttr("value", _vm.search) + " class=\"input-slide\" data-v-77cfe10c></div></div> "), _vm._ssrNode("<div class=\"content-category-left\" data-v-77cfe10c>", "</div>", [_vm._ssrNode("<div class=\"item-tittle\" data-v-77cfe10c><p class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('productdetail_categoria')) + "\n          ") + "</p></div> "), _vm.categorias.length > 7 ? _vm._ssrNode("<div class=\"btn-scroll\" data-v-77cfe10c>", "</div>", [_c('FlechaUp-icon', {
    staticClass: "btn-scroll-icon"
  })], 1) : _vm._e(), _vm._ssrNode(" <div id=\"swiper-slide-categories\" class=\"categorys-list\" data-v-77cfe10c><p class=\"txt-categorys\" data-v-77cfe10c>Todos los productos</p> " + _vm._ssrList(_vm.categorias, function (categorys, index) {
    return "<div data-v-77cfe10c><div data-v-77cfe10c><p" + _vm._ssrClass("txt-categorys", categorys.id == _vm.indexSelect ? 'txt-categorys-active' : '') + " data-v-77cfe10c>" + _vm._ssrEscape("\n                " + _vm._s(categorys.nombre_categoria_producto) + "\n              ") + "</p></div></div>";
  }) + "</div> "), _vm.categorias.length > 7 ? _vm._ssrNode("<div class=\"btn-scroll\" data-v-77cfe10c>", "</div>", [_c('Flechadown-icon', {
    staticClass: "btn-scroll-icon"
  })], 1) : _vm._e(), _vm._ssrNode(" " + (_vm.showSubCategory && _vm.selectedSubcategories.length ? "<div class=\"item-tittle\" data-v-77cfe10c><p class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_subcategory')) + "\n          ") + "</p></div>" : "<!---->") + " "), _vm.selectedSubcategories.length > 7 ? _vm._ssrNode("<div class=\"btn-scroll\" data-v-77cfe10c>", "</div>", [_c('FlechaUp-icon', {
    staticClass: "btn-scroll-icon"
  })], 1) : _vm._e(), _vm._ssrNode(" " + (_vm.showSubCategory && _vm.selectedSubcategories.length ? "<div id=\"swiper-slide-Subcategories\" class=\"subcategory-list\" data-v-77cfe10c>" + _vm._ssrList(_vm.selectedSubcategories, function (subcategorys, index) {
    return "<div data-v-77cfe10c><div data-v-77cfe10c><p" + _vm._ssrClass("txt-categorys", subcategorys.id == _vm.indexSelect2 ? 'txt-categorys-active' : '') + " data-v-77cfe10c>" + _vm._ssrEscape("\n                " + _vm._s(subcategorys.nombre_subcategoria) + "\n              ") + "</p></div></div>";
  }) + "</div>" : "<!---->") + " "), _vm.selectedSubcategories.length > 7 ? _vm._ssrNode("<div class=\"btn-scroll\" data-v-77cfe10c>", "</div>", [_c('Flechadown-icon', {
    staticClass: "btn-scroll-icon"
    ...
    return "<div" + _vm._ssrStyle(null, null, {
    ...
    }) + " data-v-77cfe10c>" + (itemsTags && itemsTags.status === 1 && itemsTags.properties.length > 0 ? "<div data-v-77cfe10c><div class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(itemsTags.name) + "\n          ") + "</div> <div class=\"categorys-list\" data-v-77cfe10c>" + _vm._ssrList(itemsTags.properties, function (itemsProperties) {
      ...
      }) + " data-v-77cfe10c>" + _vm._ssrEscape("\n              " + _vm._s(itemsProperties.name) + "\n            ") + "</button>";
    }) + "</div></div>" : "<!---->") + "</div>";
  }) + " " + (!_vm.stateShipping ? "<div class=\"content-category-left\" data-v-77cfe10c><button class=\"item-tittle\" data-v-77cfe10c><p class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_fenvio')) + "\n          ") + "</p></button> <div class=\"categorys-list\" data-v-77cfe10c><button class=\"txt-categorys\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_gratis')) + "\n          ") + "</button> <button class=\"txt-categorys\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_Singratis')) + "\n          ") + "</button></div></div>" : "<!---->") + " <div class=\"content-category-left\" data-v-77cfe10c><button class=\"item-tittle\" data-v-77cfe10c><p class=\"txt-tittles\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_fprecio')) + "\n          ") + "</p></button> <div class=\"categorys-list\" data-v-77cfe10c><button class=\"txt-categorys\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_fpreciom')) + "\n          ") + "</button> <button class=\"txt-categorys\" data-v-77cfe10c>" + _vm._ssrEscape("\n            " + _vm._s(_vm.$t('home_fprecioM')) + "\n          ") + "</button></div></div>")], 2) : _vm._e(), _vm._ssrNode(" "), _c('client-only', [_c('div', {
...
// CONCATENATED MODULE: ./components/template7/Ko-ProductListFilter.vue?vue&type=template&id=77cfe10c&scoped=true&

// EXTERNAL MODULE: ./components/template7/_productcard/ProductCard.vue + 4 modules
var ProductCard = __webpack_require__(68);

// EXTERNAL MODULE: ./components/template7/_productcard/ProductCardFilterList.vue + 4 modules
var ProductCardFilterList = __webpack_require__(617);
...
/* harmony default export */ var Ko_ProductListFiltervue_type_script_lang_js_ = ({
  ...
  mounted() {
    ...
    if (this.settingByTemplate7[0] && this.settingByTemplate7[0].productListFilter && this.settingByTemplate7[0].productListFilter.img_background) {
      this.setBg(1);
    } else {
      this.setBg(2);
    }
...
var add = __webpack_require__(7).default
module.exports.__inject__ = function (context) {
  add("33507a97", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_ProductListFilter_vue_vue_type_style_index_0_id_77cfe10c_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(495);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_ProductListFilter_vue_vue_type_style_index_0_id_77cfe10c_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_ProductListFilter_vue_vue_type_style_index_0_id_77cfe10c_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_ProductListFilter_vue_vue_type_style_index_0_id_77cfe10c_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko_ProductListFilter_vue_vue_type_style_index_0_id_77cfe10c_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".btn-scroll[data-v-77cfe10c]{cursor:pointer}.btn-scroll[data-v-77cfe10c],.btn-scroll-icon[data-v-77cfe10c]{align-items:center;display:flex;justify-content:center;width:100%}.btn-scroll-icon[data-v-77cfe10c]{bottom:.125em;color:var(--color_text);font-size:20px}.btn-scroll-icon[data-v-77cfe10c]:hover{color:var(--hover_text)}.product-content[data-v-77cfe10c]{background:var(--background_color_2);flex-direction:column;padding-bottom:80px}.content-banner-shop[data-v-77cfe10c],.product-content[data-v-77cfe10c]{align-items:center;display:flex;justify-content:center;width:100%}.content-banner-shop[data-v-77cfe10c]{background:var(--background_color_1);background-repeat:no-repeat;background-size:cover}.itemLeft-range-slide[data-v-77cfe10c]{margin-bottom:20px}.content-input-slide[data-v-77cfe10c],.itemLeft-range-slide[data-v-77cfe10c]{align-items:center;display:flex;justify-content:center;width:100%}.content-input-slide[data-v-77cfe10c]{flex-direction:column}.input-slide[data-v-77cfe10c]{cursor:pointer;width:100%}.txt-tittles[data-v-77cfe10c]{color:var(--color_text);cursor:default;font-family:var(--font-style-1)!important;font-size:16px;font-weight:600;padding-bottom:20px;padding-top:20px;text-transform:uppercase;transition:all .25s ease}.txt-tittles[data-v-77cfe10c],.value-range-slide[data-v-77cfe10c]{align-items:center;display:flex;justify-content:flex-start;width:100%}.value-range-slide[data-v-77cfe10c],.values-prices[data-v-77cfe10c]{flex-direction:row}.values-prices[data-v-77cfe10c]{align-items:center;display:flex;justify-content:flex-start;width:80%}.value-price[data-v-77cfe10c]{color:var(--color_subtext);cursor:default;font-family:var(--font-style-3)!important;font-size:14px;padding-right:1px;transition:all .25s ease;width:auto}.value-precio-change[data-v-77cfe10c]{align-items:center;display:flex;flex-direction:row;justify-content:flex-start;width:100%}.price[data-v-77cfe10c]{align-items:center;color:var(--color_text);cursor:default;display:flex;flex-direction:row;font-family:var(--font-style-3)!important;font-size:14px;font-weight:600;justify-content:flex-start;transition:all .25s ease}.item-tittle[data-v-77cfe10c]{justify-content:flex-start;width:100%}.btn-slider[data-v-77cfe10c],.item-tittle[data-v-77cfe10c]{align-items:center;display:flex}.btn-slider[data-v-77cfe10c]{justify-content:center;width:30%}.btn-items-left[data-v-77cfe10c]{align-items:center;background-color:#ededed;border-radius:35px;cursor:pointer;display:flex;font-family:var(--font-style-3)!important;font-size:12px;font-weight:600;justify-content:center;letter-spacing:.3px;padding:10px 14px;text-align:center;text-transform:uppercase;transition:all .25s ease}.btn-items-left[data-v-77cfe10c]:hover{background-color:#e5e5e5}.content-items-categorias[data-v-77cfe10c]{align-items:center;justify-content:space-between}.content-items-categorias[data-v-77cfe10c],.content-items-categorias-text[data-v-77cfe10c]{display:flex;flex-direction:row;width:100%}.text-categorias[data-v-77cfe10c]{color:var(--color_text);cursor:pointer;display:flex;flex-direction:row;font-size:14px;font-weight:600;margin-right:6px;width:auto}.separator-breadCrumbs[data-v-77cfe10c],.text-categorias[data-v-77cfe10c]{font-family:var(--font-style-3)!important}.separator-breadCrumbs[data-v-77cfe10c]{color:#8e8e8e;cursor:pointer;font-size:14px;margin-left:6px;margin-right:6px;transition:all .25s ease;width:auto}.product-stock-text[data-v-77cfe10c]{color:#8e8e8e;font-size:14px;font-weight:700}.product-stock-active[data-v-77cfe10c],.product-stock-text[data-v-77cfe10c]{font-family:var(--font-style-3)!important}.product-stock-active[data-v-77cfe10c]{color:#000;font-size:15px;font-weight:700}.text-categorias-select[data-v-77cfe10c]{color:#8e8e8e;cursor:pointer;display:flex;flex-direction:row;font-size:14px;font-weight:100;margin-right:6px;transition:all .25s ease;width:100%}#stateCate07[data-v-77cfe10c],.text-categorias-select[data-v-77cfe10c]{font-family:var(--font-style-3)!important}#stateCate07[data-v-77cfe10c]{color:#333;cursor:pointer;font-size:14px;font-weight:600}.top-content[data-v-77cfe10c]{align-items:center;display:flex;flex-wrap:wrap;font-size:100%;justify-content:space-between;margin-bottom:20px;max-width:100%;width:100%}.categorys-list[data-v-77cfe10c]{overflow-y:auto}.categorys-list[data-v-77cfe10c],.subcategory-list[data-v-77cfe10c]{grid-gap:1rem;align-items:center;display:grid;gap:1rem;grid-template-columns:repeat(1,minmax(0,1fr));justify-content:flex-start;max-height:300px;width:100%}.subcategory-list[data-v-77cfe10c]{overflow:auto}.categorys-list[data-v-77cfe10c]::-webkit-scrollbar{width:3px}.categorys-list[data-v-77cfe10c]::-webkit-scrollbar-thumb{background:#a3a3a3;border-radius:4px}.categorys-list[data-v-77cfe10c]::-webkit-scrollbar-thumb:active{background-color:#777}.categorys-list[data-v-77cfe10c]::-webkit-scrollbar-thumb:hover{background:#686868;box-shadow:0 0 2px 1px rgba(0,0,0,.401)}.subcategory-list[data-v-77cfe10c]::-webkit-scrollbar{width:3px}.subcategory-list[data-v-77cfe10c]::-webkit-scrollbar-thumb{background:#a3a3a3;border-radius:4px}.subcategory-list[data-v-77cfe10c]::-webkit-scrollbar-thumb:active{background-color:#777}.subcategory-list[data-v-77cfe10c]::-webkit-scrollbar-thumb:hover{background:#686868;box-shadow:0 0 2px 1px rgba(0,0,0,.401)}.container[data-v-77cfe10c]::-webkit-scrollbar-track{background:#323232;border-radius:4px}.container[data-v-77cfe10c]::-webkit-scrollbar-track:active,.container[data-v-77cfe10c]::-webkit-scrollbar-track:hover{background:#b52727}.content-category-left[data-v-77cfe10c]{align-items:center;display:flex;flex-direction:column;justify-content:flex-start;width:100%}.txt-categorys[data-v-77cfe10c]{align-items:center;color:var(--color_subtext);cursor:pointer;display:flex;flex-direction:row;font-size:14px;justify-content:flex-start;padding-right:4px;transition:all .25s ease;width:100%}.txt-categorys[data-v-77cfe10c],.txt-categorys-active[data-v-77cfe10c]{font-family:var(--font-style-3)!important}.txt-categorys-active[data-v-77cfe10c]{align-items:center;color:#0c0c0c;cursor:pointer;display:flex;flex-direction:row;font-size:14px;font-weight:700;justify-content:flex-start;padding-right:4px;transition:all .25s ease;width:100%}.product-stock[data-v-77cfe10c]{color:#333;cursor:pointer;font-family:var(--font-style-3)!important;font-size:14px;font-weight:600;margin-right:6px;transition:all .25s ease}.show-view-per-list[data-v-77cfe10c]{grid-gap:1rem;align-items:center;display:grid;gap:1rem;grid-template-columns:repeat(4,minmax(0,1fr));justify-content:center;width:auto}.show[data-v-77cfe10c]{cursor:pointer;width:100%}.show-icon[data-v-77cfe10c]{fill:#8e8e8e}.show-icon-active[data-v-77cfe10c]{fill:#0c0c0c}.show-icon[data-v-77cfe10c]:hover,.show:focus .show-icon[data-v-77cfe10c]{fill:var(--color_text)}.items-end[data-v-77cfe10c]{flex-direction:row;justify-content:flex-end}.items-end[data-v-77cfe10c],.tittle-banner-shop[data-v-77cfe10c]{align-items:center;display:flex;width:100%}.tittle-banner-shop[data-v-77cfe10c]{flex-wrap:wrap;justify-content:center}.btn-tittle-shop[data-v-77cfe10c]{color:var(--color_title);font-family:var(--font-style-1)!important;font-weight:400}.txt-categorys[data-v-77cfe10c]:hover{color:#050505}.product-text[data-v-77cfe10c]{align-items:center;justify-content:center}.product-content-items[data-v-77cfe10c],.product-text[data-v-77cfe10c]{display:flex;flex-direction:column;width:100%}.product-content-items[data-v-77cfe10c]{align-items:flex-start;justify-content:flex-start;text-align:center}.description[data-v-77cfe10c],.product-description[data-v-77cfe10c],.product-subtittle[data-v-77cfe10c],.product-tittle[data-v-77cfe10c],.subtittle[data-v-77cfe10c],.tittle[data-v-77cfe10c]{align-items:center;display:flex;flex-direction:column;justify-content:center;text-align:center}.producto-items-content[data-v-77cfe10c]{width:100%}.tittle[data-v-77cfe10c]{color:#ed2353;font-family:var(--font-style-2)!important}.subtittle[data-v-77cfe10c]{color:var(--color_text);font-family:var(--font-style-1)!important}.description[data-v-77cfe10c]{color:#777;font-family:var(--font-style-3)!important}.product-content-items[data-v-77cfe10c]{gap:1rem}.content-item[data-v-77cfe10c]{flex-direction:row;justify-content:space-between;margin-bottom:40px}.content-item[data-v-77cfe10c],.content-item-productos[data-v-77cfe10c]{align-items:center;display:flex;width:100%}.content-item-productos[data-v-77cfe10c]{flex-direction:column;justify-content:center}.grid-products[data-v-77cfe10c]{grid-column-gap:25px;grid-row-gap:30px;box-sizing:border-box;display:grid;grid-template-columns:repeat(4,minmax(250px,2fr));margin:0 auto;width:100%}.content-products[data-v-77cfe10c]{border-bottom:.5px solid #f2f2f2;height:100%}.content-products-empty[data-v-77cfe10c]{align-items:center;display:flex;flex-direction:column;justify-content:center;min-height:200px;text-align:center;width:100%}.txt-products-empty[data-v-77cfe10c]{color:#3f3f3f;font-family:var(--font-style-1)!important;font-size:20px;font-weight:600;margin-top:6px}.pagination-medium[data-v-77cfe10c]{background:transparent;margin-top:50px}.pagination[data-v-77cfe10c]{background:transparent;color:#3f3f3f;font-size:18px}.product_pagination[data-v-77cfe10c] .el-pagination.is-background .btn-next,.product_pagination[data-v-77cfe10c] .el-pagination.is-background .btn-prev,.product_pagination[data-v-77cfe10c] .el-pagination.is-background .el-pager li{background-color:transparent;color:#3f3f3f}.product_pagination[data-v-77cfe10c] .el-pagination.is-background .btn-next:hover,.product_pagination[data-v-77cfe10c] .el-pagination.is-background .btn-prev:hover,.product_pagination[data-v-77cfe10c] .el-pagination.is-background .el-pager li:not(.disabled):hover{color:var(--hover_card)}.product_pagination[data-v-77cfe10c] .el-pagination.is-background .el-pager li:not(.disabled).active{background-color:var(--hover_card);color:#fff}.product-stock[data-v-77cfe10c],.separator-breadCrumbs[data-v-77cfe10c],.show-number-items[data-v-77cfe10c]{cursor:default}@media (min-width:300px){#grid-selection[data-v-77cfe10c]{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.btn-tittle-shop[data-v-77cfe10c]{font-size:36px}.content-banner-shop[data-v-77cfe10c]{padding-top:80px}.tittle-banner-shop[data-v-77cfe10c]{margin-bottom:6px;margin-top:6px}.content-shop-items[data-v-77cfe10c]{align-items:center;display:flex;flex-direction:column;justify-content:center;width:95%}.content-left[data-v-77cfe10c]{display:none}.content-right[data-v-77cfe10c]{width:100%}.top-content[data-v-77cfe10c]{border-bottom:1px solid #e8e8e8;padding-bottom:12px;padding-top:12px}.items-end[data-v-77cfe10c]{display:none}.content-items-categorias-text[data-v-77cfe10c]{align-items:center;justify-content:center}.text-categorias-select[data-v-77cfe10c]{width:auto}}@media (min-width:768px){.product-content-items[data-v-77cfe10c]{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}#grid-selection[data-v-77cfe10c]{display:grid;grid-template-columns:repeat(4,minmax(0,1fr))}}@media (min-width:1024px){.product-text[data-v-77cfe10c]{width:100%}.product-content-items[data-v-77cfe10c]{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.content-items-categorias-text[data-v-77cfe10c]{align-items:center;justify-content:flex-start}.items-end[data-v-77cfe10c],.show-number-items[data-v-77cfe10c]{display:flex}.show-number-items[data-v-77cfe10c]{align-items:center;justify-content:flex-end;width:100%}.show-view-per-list[data-v-77cfe10c]{display:none}}@media (min-width:1280px){.btn-tittle-shop[data-v-77cfe10c]{font-size:78px}.content-banner-shop[data-v-77cfe10c]{margin-bottom:40px;padding-bottom:70px;padding-top:150px}.tittle-banner-shop[data-v-77cfe10c]{margin-bottom:6px;margin-top:6px}.content-shop-items[data-v-77cfe10c]{align-items:flex-start;display:flex;flex-direction:row;justify-content:flex-start;width:93%}.top-content[data-v-77cfe10c]{border-bottom:1px solid #e8e8e8;padding-bottom:5px;padding-top:0}.content-left[data-v-77cfe10c]{align-items:flex-start;display:flex;flex-direction:column;justify-content:space-between;margin-right:24px;width:30%}.show-view-per-list[data-v-77cfe10c]{grid-gap:1rem;display:grid;gap:1rem;grid-template-columns:repeat(4,minmax(0,1fr));width:auto}.show-number-items[data-v-77cfe10c],.show-view-per-list[data-v-77cfe10c]{align-items:center;justify-content:center}.show-number-items[data-v-77cfe10c]{display:flex;width:100%}#stateCate07[data-v-77cfe10c],..text-categorias-select[data-v-77cfe10c],.separator-breadCrumbs[data-v-77cfe10c],.text-categorias[data-v-77cfe10c]{margin-bottom:20px}}@media (min-width:1192px){.content-shop-items[data-v-77cfe10c]{width:1192px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
