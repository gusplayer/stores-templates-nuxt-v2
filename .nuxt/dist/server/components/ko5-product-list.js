...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("68f631e3", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductList_vue_vue_type_style_index_0_id_45ec133d_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(320);
/* harmony import */ var _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductList_vue_vue_type_style_index_0_id_45ec133d_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductList_vue_vue_type_style_index_0_id_45ec133d_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductList_vue_vue_type_style_index_0_id_45ec133d_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_thread_loader_dist_cjs_js_ref_3_oneOf_1_0_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_1_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Ko5_ProductList_vue_vue_type_style_index_0_id_45ec133d_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".text-macrobrand[data-v-45ec133d]{align-items:center;display:flex;flex-direction:column;justify-content:center;margin-bottom:30px;margin-top:0}.text-macrobrand>p[data-v-45ec133d]{color:var(--color_text);font-size:20px;font-weight:700;padding:5px 20px;text-align:center}.wrapper-productlist[data-v-45ec133d]{align-items:center;background:var(--background_color_2);box-sizing:border-box}.container-productlist[data-v-45ec133d],.wrapper-productlist[data-v-45ec133d]{display:flex;justify-content:center;width:100%}.container-productlist[data-v-45ec133d]{flex-direction:column;max-width:1300px;padding:40px 20px}.content-sticky[data-v-45ec133d]{position:sticky;top:118px;width:100%}.content-item[data-v-45ec133d]{display:flex;flex-direction:row;justify-content:space-between}.content-item>div[data-v-45ec133d]:first-child{flex:1;max-width:300px}.content-item>div[data-v-45ec133d]:nth-child(2){flex:2}.wrapper-filter[data-v-45ec133d]{align-items:flex-start;display:flex;flex-direction:column;justify-content:flex-start;list-style:none;width:100%}.content-categoria[data-v-45ec133d]{padding-right:20px;width:100%}.text-categoria[data-v-45ec133d]{color:var(--color_text);font-size:16px;width:100%}.text-subcategoria[data-v-45ec133d]{color:var(--color_subtext);cursor:pointer;font-size:16px;margin-bottom:10px;margin-left:5px;width:100%}.text-categoria-active[data-v-45ec133d],.text-subcategoria-active[data-v-45ec133d]{color:var(--color_hover_text)}.content-items-categorias-text[data-v-45ec133d]{display:flex;flex-direction:row;margin-bottom:15px;position:sticky;top:88px}.text-categorias[data-v-45ec133d]{font-size:18px}.text-categorias[data-v-45ec133d],.text-categorias-select[data-v-45ec133d]{align-self:flex-start;background:transparent;color:var(--color_subtext);cursor:pointer;display:flex;font-weight:700;line-height:1.4;margin-right:2px}.text-categorias-select[data-v-45ec133d]{font-size:16px;margin-left:5px;opacity:.6}.content-item-productos[data-v-45ec133d]{align-items:center;display:flex;flex-direction:column;justify-content:flex-start;width:100%}.grid-products[data-v-45ec133d]{grid-column-gap:25px;grid-row-gap:30px;box-sizing:border-box;display:grid;grid-template-columns:repeat(3,minmax(250px,2fr));margin:0 auto;width:100%}.content-products-empty[data-v-45ec133d]{align-items:center;display:flex;justify-content:center;min-height:calc(100vh - 461px);text-align:center;width:100%}.content-products-empty p[data-v-45ec133d]{color:var(--color_subtext);font-size:18px;font-weight:700;opacity:.6}.pagination-medium[data-v-45ec133d]{background:transparent;margin-top:10px}.pagination[data-v-45ec133d]{background:transparent;color:var(--color_text);font-size:18px}.product_pagination[data-v-45ec133d] .el-pagination.is-background .btn-next,.product_pagination[data-v-45ec133d] .el-pagination.is-background .btn-prev,.product_pagination[data-v-45ec133d] .el-pagination.is-background .el-pager li{background-color:transparent;color:var(--color_text)}.product_pagination[data-v-45ec133d] .el-pagination.is-background .btn-next:hover,.product_pagination[data-v-45ec133d] .el-pagination.is-background .btn-prev:hover,.product_pagination[data-v-45ec133d] .el-pagination.is-background .el-pager li:not(.disabled):hover{color:var(--btnhover)}.product_pagination[data-v-45ec133d] .el-pagination.is-background .el-pager li:not(.disabled).active{background-color:var(--color_icon);color:#fff}@media (max-width:1290px){.grid-products[data-v-45ec133d]{grid-column-gap:15px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1265px){.grid-products[data-v-45ec133d]{grid-column-gap:10px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1250px){.grid-products[data-v-45ec133d]{grid-column-gap:25px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(250px,2fr))}}@media (max-width:1060px){.grid-products[data-v-45ec133d]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(250px,2fr))}}@media (max-width:1050px){.grid-products[data-v-45ec133d]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1020px){.grid-products[data-v-45ec133d]{grid-column-gap:15px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1010px){.grid-products[data-v-45ec133d]{grid-column-gap:10px;grid-row-gap:30px;grid-template-columns:repeat(3,minmax(240px,2fr))}}@media (max-width:1000px){.grid-products[data-v-45ec133d]{grid-column-gap:25px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:790px){.grid-products[data-v-45ec133d]{grid-column-gap:20px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:780px){.grid-products[data-v-45ec133d]{grid-column-gap:16px;grid-row-gap:30px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:775px){.grid-products[data-v-45ec133d]{grid-column-gap:20px;grid-row-gap:20px;grid-template-columns:repeat(2,minmax(250px,2fr))}}@media (max-width:770px){.container-productlist[data-v-45ec133d]{padding:0}.content-items-categorias-text[data-v-45ec133d]{padding:20px 10px 10px}.content-item-productos[data-v-45ec133d]{padding:0 15px}.grid-products[data-v-45ec133d]{grid-template-columns:repeat(2,minmax(10px,2fr))}.wrapper-filter[data-v-45ec133d]{padding-left:10px}.content-categoria[data-v-45ec133d]{padding-right:0}}@media (max-width:700px){.content-items-categorias[data-v-45ec133d]{margin-bottom:0;margin-left:5px}.wrapper-filter[data-v-45ec133d]{display:none}}@media (max-width:450px){.grid-products[data-v-45ec133d]{grid-template-columns:repeat(2,minmax(160px,1fr))}.content-item-productos[data-v-45ec133d]{padding:5px}.text-macrobrand>p[data-v-45ec133d]{font-size:16px}.text-macrobrand[data-v-45ec133d]{margin-bottom:10px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/template5/Ko5-ProductList.vue?vue&type=template&id=45ec133d&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "wrapper-productlist"
  }, [_vm._ssrNode("<div class=\"container-productlist\" data-v-45ec133d>", "</div>", [_vm._ssrNode("<div class=\"content-items-categorias-text\" data-v-45ec133d><p class=\"text-categorias\" data-v-45ec133d>Catálogo</p> " + (this.nameCategoryHeader ? "<p class=\"text-categorias-select\" data-v-45ec133d>" + _vm._ssrEscape("\n        > " + _vm._s(this.nameCategoryHeader) + "\n      ") + "</p>" : "<!---->") + " " + (this.nameSubCategoryHeader ? "<p class=\"text-categorias-select\" data-v-45ec133d>" + _vm._ssrEscape("\n        > " + _vm._s(this.nameSubCategoryHeader) + "\n      ") + "</p>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"content-item\" data-v-45ec133d>", "</div>", [_vm._ssrNode("<div class=\"wrapper-filter\" data-v-45ec133d>", "</div>", [_vm._ssrNode("<div class=\"content-sticky\" data-v-45ec133d>", "</div>", _vm._l(_vm.categorias, function (categoria) {
    return _vm._ssrNode("<div class=\"content-categoria\" data-v-45ec133d>", "</div>", [_c('BaseAccordian', {
      scopedSlots: _vm._u([{
        key: "categorias",
        fn: function () {
          return [_c('li', {
  ...
  }), 0)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"content-item-productos\" data-v-45ec133d>", "</div>", [_vm._ssrNode("<div class=\"grid-products\" data-v-45ec133d>", "</div>", _vm._l(_vm.filterProduct, function (product) {
    return _vm._ssrNode("<div class=\"content-products\" data-v-45ec133d>", "</div>", [_c('KoProductCard1', {
      attrs: {
        "product": product
      }
    })], 1);
  }), 0), _vm._ssrNode(" " + (this.fullProducts.length == 0 ? "<div class=\"content-products-empty\" data-v-45ec133d><p data-v-45ec133d>No se encontraron productos relacionados.</p></div>" : "<!---->") + " "), _vm._ssrNode("<div class=\"pagination-medium\" data-v-45ec133d>", "</div>", [_vm.fullProducts.length > 24 ? _vm._ssrNode("<div class=\"product_pagination\" data-v-45ec133d>", "</div>", [_c('el-pagination', {
...
// CONCATENATED MODULE: ./components/template5/Ko5-ProductList.vue?vue&type=template&id=45ec133d&scoped=true&
...
var _AccordionListvue_type_template_id_6ee55808_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "wrapper"
...
var _AccordionListvue_type_template_id_6ee55808_scoped_true_staticRenderFns = [];
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  _AccordionListvue_type_template_id_6ee55808_scoped_true_render,
  _AccordionListvue_type_template_id_6ee55808_scoped_true_staticRenderFns,
  false,
  injectStyles,
  "6ee55808",
  "6358a02c"
...
/* harmony default export */ var _AccordionList = (component.exports);
...
function Ko5_ProductList_injectStyles (context) {
...
var Ko5_ProductList_component = Object(componentNormalizer["a" /* default */])(
  template5_Ko5_ProductListvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  Ko5_ProductList_injectStyles,
  "45ec133d",
  "10ee0a4b"
  
)

/* harmony default export */ var Ko5_ProductList = __webpack_exports__["default"] = (Ko5_ProductList_component.exports);

/***/ })

};;
//# sourceMappingURL=ko5-product-list.js.map