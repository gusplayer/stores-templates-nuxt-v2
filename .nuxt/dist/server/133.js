...
// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js??ref--2-0!./node_modules/babel-loader/lib??ref--2-1!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./components/template14/ko14-information.vue?vue&type=template&id=1e03762e&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.information ? _c('div', {
    staticClass: "w-full flex justify-center items-center py-15 lg:py-20",
    staticStyle: {
      "background-color": "var(--background_color_1)"
    },
    style: [_vm.information, _vm.settingGeneral]
  }, [_vm._ssrNode("<div class=\"w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 mlg:grid-cols-4 gap-5 md:gap-3 items-center\">", "</div>", _vm._l(_vm.information.values, function (items, index) {
    return _vm._ssrNode("<div class=\"flex flex-row items-center justify-center\">", "</div>", [_c('img', {
      directives: [{
        name: "lazy",
        rawName: "v-lazy",
      ...
      staticClass: "object-contain object-center",
...
// CONCATENATED MODULE: ./components/template14/ko14-information.vue?vue&type=template&id=1e03762e&
