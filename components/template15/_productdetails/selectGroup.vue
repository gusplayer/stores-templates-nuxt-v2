<template>
  <div class="w-full py-10">
    ...
    <div
      class="select relative flex bg-transparent overflow-hidden w-full max-w-[300px] border-2 py-11"
      :style="`border-color:${detailsProducts.color_border}; border-radius: ${settingGeneral.radius};`"
    >
      <select
        ref="format"
        name="format"
