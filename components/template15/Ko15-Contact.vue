<template>
  ...
  >
    <div
      ...
      :style="`background-color: ${settingByTemplate15[0].contact['--background_color_1']}`"
    >
      <div class="w-full relative box-content hidden md:flex">
        <div v-if="settingByTemplate15[0].contact.visible_img">
          <picture>
            <source
              media="(max-width: 799px)"
              :srcset="
                idCloudinaryBanner(
                  settingByTemplate15[0].contact.img,
                  'bannerRes',
                  400
                )
              "
            ...
            />
            <img
              v-lazy="settingByTemplate15[0].contact.img"
        ...
        >
          <p
            ...
            :style="`color: ${settingByTemplate15[0].contact.color_title};`"
          >
            {{ $t('header_contacto') }}
          </p>
          <div
            class="flex flex-row items-center justify-center"
            :style="`color: ${settingByTemplate15[0].contact.color_breadCrumbs};`"
          >
      ...
      <div
        class="w-full flex flex-col md:flex-row justify-center md:justify-start"
      >
        <div class="w-full max-w-2/0" />
        <div v-if="dataStore.geolocalizacion.length" class="w-full relative">
            ...
            <div class="pl-10">
              ...
              >
                <div class="w-full max-w-[50px]">
                  <svg
                    :fill="settingByTemplate15[0].contact.color_icon"
      ...
      <div
        ...
        :style="`background-color: ${settingByTemplate15[0].contact['--background_color_2']}`"
      >
        <div
        ...
        >
          <p
            ...
            :style="`color: ${settingByTemplate15[0].contact.color_title_form};`"
          >
            {{ $t('home_contactenos') }}
          </p>
          <ValidationObserver
                ...
                <validation-provider name="nombre" rules="required">
                  <template slot-scope="{ errors }">
                    <input
                      ...
                      type="text"
                      class="input-text"
                      :style="`color: ${settingByTemplate15[0].contact.color_text_input}; background-color:${settingByTemplate15[0].contact.color_input}; border-color:${settingByTemplate15[0].contact.color_title_form};`"
