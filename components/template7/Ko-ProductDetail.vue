<template>
  ...
  >
    ...
    >
      <div class="w-full flex flex-col md:flex-row">
        ...
        <div class="wrapper-right">
          <div class="content-right">
            ...
            <div
              class="mt-0 pb-10 md:mt-15 md:pb-20 fixed md:relative w-full flex flex-row justify-center md:justify-start items-center left-0 bottom-0 px-6 pt-10 md:px-0 md:pt-0 bg-gray-200 md:bg-white-white border-t md:border-t-0 z-100 md:z-0 md:border-b border-color"
            >
              <div class="quantity">
      ...
      <div class="section">
        <div class="features">
          <KoDescription :data-store="dataStore" :data="data" :envio="envio" />
        </div>
      </div>
