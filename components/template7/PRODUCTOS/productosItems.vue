<template>
  <div class="producto">
    <div class="container">
      <img class="image" :src="productos.photo" alt="productos" />
    ...
    <div class="datos-producto">
      <div class="tittle">{{ productos.tittle }}</div>
      <div class="description">{{ productos.description }}</div>
      <div class="precio">{{ productos.precio }}</div>
    </div>
  </div>
</template>
<script>
...
.cart-Shop {
  @apply text-white-white absolute text-center transition-all ease-in duration-300;
  font: inherit;
  font-size: 100%;
  top: 50%;
  left: 50%;
