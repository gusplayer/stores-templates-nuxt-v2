        ...
        <div class="right">
          <div class="content-items-right">
            ...
            <div class="content-name">
              <p
                class="text-name"
                :style="`font-size:${settingByTemplate13[0].detailsProduct['--fontSizeTitle']}; font-weight:${settingByTemplate13[0].detailsProduct['--fontWeighTitle']};`"
              >
                {{ data.nombre }}
              </p>
            </div>
            <div class="content-price">
              <p
                ...
                class="text-price"
                :style="`font-size:${settingByTemplate13[0].detailsProduct['--fontSizePrice']}; font-weight:${settingByTemplate13[0].detailsProduct['--fontWeighPrice']};`"
              >
                {{
                  salesData.precio
                    | currency(
            ...
            <div
              class="mt-0 pb-10 md:mt-15 md:pb-20 fixed md:sticky w-full flex gap-x-4 flex-row md:flex-col justify-center md:justify-start items-center left-0 bottom-0 px-6 pt-10 md:px-0 md:pt-0 border-t md:border-t-0 z-100 md:z-0 md:border-b"
