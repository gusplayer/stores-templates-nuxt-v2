    ...
    <div class="contenedor">
      ...
      <div class="content-right">
        <div>
          ...
          <p class="subtitle-error">¡OOPS! Error.</p>
...
export default {
  ...
  methods: {
    ...
    redirectWhatsapp() {
      if (this.mobileCheck()) {
        window.open(
          `https://wa.me/573107884893/?text=Hola.%0A%0ATengo%20un%20problema%20con%20mi%20tienda%20${window.location}.`,
          '_blank'
        )
      } else {
        window.open(
          `https://web.whatsapp.com/send?phone=573107884893&text=Hola.%0A%0ATengo%20un%20problema%20con%20mi%20tienda%20${window.location}.`,
          '_blank'
        )
      }
    },
