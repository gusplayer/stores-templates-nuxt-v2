  ...
  >
    ...
    >
      <div class="w-full flex flex-col justify-center items-center">
            ...
            <div class="content-store-sm">
              ...
              <div class="info-store-sm mb-20">
                ...
                <div class="content-direction">
                  <p v-if="dataStore.geolocalizacion.length" class="txt">
          ...
          <div class="content-items-lg">
            <div class="info-btn-footer gap-2">
              ...
              <p class="txt mb-20">
                ...
                <span v-if="dataStore.tienda.email_tienda" class="ml-3">
                  {{ dataStore.tienda.email_tienda }}
                </span>
              </p>
              <div
        ...
        <div v-if="settingByTemplate16[0].footer.watermark" class="empty" />
        <div
