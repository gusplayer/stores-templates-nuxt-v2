  ...
  <div class="content-cart">
    <div class="conten-items-cart">
      <div class="cart-tittle">
        <p class="txt-cart">Tu carrito</p>
      </div>
      <div class="content-product-total">
        <div class="content-left" v-if="this.productsCart.length">
          <div
        ...
        <div class="content-right">
          ...
          <div class="content-cart-product">
            ...
            <div class="content-btn">
              ...
              <div class="button-length" v-if="this.productsCart.length">
                <button
                  ref="colorBtn"
                  class="btn-buy-1"
                  @click="GoPayments"
              ...
              <div class="button-length" v-else>
                <button ref="colorBtn" class="btn-buy-disabled">
                  {{ $t('footer_finalizarCompra') }}
                </button>
              </div>
...
@screen sm {
  ...
  .btn-buy-disabled {
    ...
    border-color: #222;
    color: #fff;
    @apply w-full h-40 flex justify-center items-center font-semibold border-2 rounded-md mb-10 mt-30 opacity-50;
  }
  .btn-buy-1 {
    background-color: #222;
    border-color: #222;
  ...
  .photo {
    ...
    @apply object-cover object-center rounded-10;
  }
  .btn3 {
    color: #fff;
    background-color: #222;
    ...
    @apply mt-10 cursor-pointer font-bold;
  }
}
