      ...
      >
        <div class="wrapper-left">
          <img
            class="img-left"
            v-lazy="
              idCloudinary(this.section.values[0].url_img_background, 550, 550)
            "
            alt="banner-1"
          />
          <div
      ...
      >
        <div class="wrapper-center">
          <img
            class="img-center"
            v-lazy="
              idCloudinary(this.section.values[1].url_img_background, 550, 550)
            "
            alt="banner-2"
          />
          <div
      ...
      >
        <div class="wrapper-right">
          <img
            class="img-right"
            v-lazy="
              idCloudinary(this.section.values[2].url_img_background, 550, 550)
            "
            alt="banner-3"
          />
          <div
...
.txt-content {
  @apply absolute w-full h-full flex flex-col justify-start items-start;
}
...
@screen sm {
  ...
  .wrapper-left:hover .txt-tittle {
    color: var(--hover_text);
  }
  .wrapper-center:hover .txt-tittle {
    color: var(--hover_text);
  }
  .wrapper-right:hover .txt-tittle {
    color: var(--hover_text);
  }
  .txt-tittle {
    /* color: #222222; */
