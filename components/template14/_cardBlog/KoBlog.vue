  ...
  >
    <div class="flex w-full max-w-7xl flex-col items-center justify-center">
      <div class="flex w-full flex-row items-center justify-between">
        <p class="text-left text-30 font-semibold text-black">Últimos blogs</p>
        <input
      ...
      <div class="mt-30 flex w-full flex-col items-center justify-center">
        <div
          class="mb-40 box-border grid h-full w-full grid-cols-1 items-center justify-center gap-4 md:grid-cols-3 lg:grid-cols-4 mlg:gap-8"
        >
          <div
