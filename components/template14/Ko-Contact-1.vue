<template>
  ...
  >
    ...
    >
      <div class="w-full relative box-content hidden md:flex">
        <div v-if="settingByTemplate14[0].contact.visible_img">
          <picture>
            ...
            />
            <img
              v-lazy="settingByTemplate14[0].contact.img"
      ...
      >
        <div
          class="w-full max-w-7xl flex flex-col my-40 md:my-80 border p-30 justify-center"
          :style="`background-color: ${settingByTemplate14[0].contact.color_bg_form};`"
        >
          <p
            class="text-25 font-bold mb-15 text-center"
