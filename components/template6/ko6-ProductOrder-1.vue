    ...
    <div class="container">
      ...
      <div class="content-item-productos">
        <div class="grid-products">
          ...
          >
            <Ko6ProductCard1 :product="product"></Ko6ProductCard1>
          </div>
        </div>
        <div
...
<script>
import Ko6ProductCard1 from './_productcard/Ko6-ProductCard-1'
export default {
