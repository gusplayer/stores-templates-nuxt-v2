<template>
  <div
    ...
    :style="[
      ...
      productOverviews,
      {
        '--font-style-1': settingsGeneral?.fount_1 ?? 'Poppins',
      },
    ]"
  >
    <el-collapse v-model="activeNames" accordion>
      <el-collapse-item
        ...
        name="1"
        class="border-t"
        :style="`color: ${productOverviews.color_text}; border-color:${productOverviews.color_border}`"
      >
        <div class="editor">
          <el-tiptap
      ...
      >
        <div
          class="grid max-h-[550px] w-full grid-cols-1 items-start justify-start gap-4 overflow-y-auto pb-4 md:grid-cols-2"
        >
          <div v-if="mediospago.consignacion == 1">
            <h4 :style="`color: ${productOverviews.color_text};`">
              {{ $t('productdetail_consignacionBancaria') }}
            </h4>
            <p :style="`color: ${productOverviews.color_subtext};`">
          ...
          <div v-if="mediospago.wepay4u == 1">
            <h4 :style="`color: ${productOverviews.color_text};`">WePay4U</h4>
            <p :style="`color: ${productOverviews.color_subtext};`">
              {{ $t('text_pago_WePay4U') }}
            </p>
            <a
            ...
            >
              <img
                src="https://img.komercia.store/komerciaacademico/image/upload/c_scale,w_500,q_auto:best,f_auto/v1639078440/wePay4u/powered_by_z7sgqp.png"
                alt="wePay4u"
                border="0"
              />
            </a>
          ...
          <div v-if="mediospago.tu_compra == 1">
            <h4 :style="`color: ${productOverviews.color_text};`">Tucompra</h4>
            <p :style="`color: ${productOverviews.color_subtext};`">
            ...
            >
              <img
                src="https://img.komercia.store/komerciaacademico/image/upload/c_scale,w_500,q_auto:best,f_auto/v1645131256/komerica/tucompra_ss0oys.png"
                alt="tu_compra"
                border="0"
              />
            </a>
          ...
          <div v-if="mediospago.flow == 1">
            <h4 :style="`color: ${productOverviews.color_text};`">Flow</h4>
            <p :style="`color: ${productOverviews.color_subtext};`">
            ...
            >
              <img
                src="https://img.komercia.store/komerciaacademico/image/upload/c_scale,w_500,q_auto:best,f_auto/v1645131256/komerica/flow_jevnwy.png"
                alt="flow"
                border="0"
              />
            </a>
