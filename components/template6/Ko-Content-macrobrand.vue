          ...
          data: [
            {
              title_1: 'Macrobrand',
              photo:
                'https://res.cloudinary.com/komercia-store/image/upload/v1568416451/lcq1s1in57fepimxd6eq.png',
              description:
                'Es una compañía dedicada a desarrollar estrategias para monetizar y elevar el valor de las marcas.',
